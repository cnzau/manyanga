...
},bindSingleAndDoubleClick:function(_1c7,_1c8,_1c9,_1ca,_1cb){
_1cb=_1cb||500;
$(_1c7).click(function(_1cc){
...
}).dblclick(function(_1cd){
clearTimeout($(this).data("timer"));
$(this).data("timer",null);
return _1c9(_1cd);
});
},bindInput:function(_1ce,_1cf,_1d0,_1d1){
if(_1d1===undefined){
_1d1=_1cf;
}
Mousetrap(_1ce).bind("enter",_1cf);
Mousetrap(_1ce).bind(["escape","esc"],_1d0,"keyup");
if(_1d1){
$(_1ce).blur(_1d1);
}
},emptyNode:function(node){
var _1d2=this.getChildren(node);
for(var i=_1d2.length-1;i>=0;i--){
node.removeChild(_1d2[i]);
}
...
var _1d3=node.childNodes;
var _1d4=[];
for(var i=0;i<_1d3.length;i++){
if(_1d3[i].nodeType===Node.ELEMENT_NODE){
_1d4.push(_1d3[i]);
}
}
return _1d4;
}
},scrollToRelative:function(_1d5,_1d6,_1d7){
var to=_1d5.scrollTop+_1d6;
this.scrollTo(_1d5,to,_1d7);
},scrollTo:function(_1d8,to,_1d9){
$(_1d8).animate({scrollTop:to},_1d9);
},xmlEncode:function(_1da){
return _1da.toString().replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/"/g,"&quot;");
},xmlDecode:function(_1db){
return _1db.toString().replace(/&quot;/g,"\"").replace(/&lt;/g,"<").replace(/&amp;/g,"&");
},convertDate:function(_1dc){
if(_1dc=="7000000000000"){
return "not yet saved";
}
return Ext.util.Format.date(new Date(parseInt(_1dc)),"Y-m-d G:i");
},appendVersionQuery:function(_1dd){
return _1dd+"?v="+rabbit.parameters.codeVersion;
},cloneObject:function(_1de){
return JSON.parse(JSON.stringify(_1de));
},Class:function(_1df,_1e0){
if(!_1e0){
_1e0=_1df;
_1df=function(){
};
...
this.parent=_1df.prototype;
this.init.apply(this,arguments);
}
};
_1e0.call(F.prototype=new _1df(rabbit.util.Class),_1df.prototype);
return F;
},absoluteCenter:function(_1e1){
var left=$(_1e1).parent().width()/2-$(_1e1).width()/2;
var top=$(_1e1).parent().height()/2-$(_1e1).height()/2;
$(_1e1).css({left:left,top:top,position:"absolute"});
},getResolvedPromise:function(){
var _1e2=new jQuery.Deferred();
_1e2.resolve();
return _1e2.promise();
},addClass:function(_1e3,_1e4){
if(typeof _1e3==="string"){
_1e3=document.getElementById(_1e3);
}
_1e3.setAttribute("class",_1e3.getAttribute("class")+" "+_1e4);
},removeClass:function(_1e5,_1e6){
if(typeof _1e5==="string"){
_1e5=document.getElementById(_1e5);
}
_1e5.setAttribute("class",_1e5.getAttribute("class").replace(_1e6,""));
...
return 1;
},insertAtIndex:function(_1e7,key,_1e8,_1e9){
var tmp={};
var keys=_.keys(_1e7);
for(var i=0;i<keys.length;i++){
if(i>=_1e9){
tmp[keys[i]]=_1e7[keys[i]];
delete _1e7[keys[i]];
}
}
_1e7[key]=_1e8;
...
var _1ea=this.getChildren(node);
for(var i=0;i<_1ea.length;i++){
this.recursivelyRemoveId(_1ea[i]);
}
...
_1eb.style.visibility="hidden";
_1eb.style.width="100px";
_1eb.style.msOverflowStyle="scrollbar";
document.body.appendChild(_1eb);
var _1ec=_1eb.offsetWidth;
_1eb.style.overflow="scroll";
var _1ed=document.createElement("div");
_1ed.style.width="100%";
_1eb.appendChild(_1ed);
var _1ee=_1ed.offsetWidth;
_1eb.parentNode.removeChild(_1eb);
this.scrollbarWidth=_1ec-_1ee;
return this.scrollbarWidth;
}};
...
var data={"errorJSON":JSON.stringify(e),"message":e.name+": "+e.message,"url":file,"line":line,"stack":e.stack};
...
rabbit.facade={registerUserPref:function(key,_1ef){
rabbit.common.prefsManager.registerUserPref(key,_1ef);
},setUserPref:function(key,_1f0){
rabbit.common.prefsManager.setUserPref(key,_1f0);
},getUserPref:function(key){
return rabbit.common.prefsManager.getUserPref(key);
},setFrameSpecificUserPref:function(_1f1,_1f2,key,_1f3){
var _1f4=rabbit.util.cloneObject(rabbit.facade.getUserPref(key));
_1f4[_1f1]=_1f4[_1f1]||{};
_1f4[_1f1][_1f2]=_1f3;
rabbit.facade.setUserPref(key,_1f4);
},getFrameSpecificUserPref:function(_1f5,_1f6,key){
var _1f7=rabbit.facade.getUserPref(key);
if(_1f7[_1f5]&&_1f7[_1f5][_1f6]){
return _1f7[_1f5][_1f6];
}else{
return null;
}
},registerPrototypePref:function(key,_1f8){
rabbit.common.prefsManager.registerPrototypePref(key,_1f8);
},setPrototypePref:function(key,_1f9){
rabbit.common.prefsManager.setPrototypePref(key,_1f9);
},getPrototypePref:function(key){
return rabbit.common.prefsManager.getPrototypePref(key);
},setFrameSpecificPrototypePref:function(_1fa,_1fb,key,_1fc){
var _1fd=rabbit.util.cloneObject(rabbit.facade.getPrototypePref(key));
_1fd[_1fa]=_1fd[_1fa]||{};
_1fd[_1fa][_1fb]=_1fc;
rabbit.facade.setPrototypePref(key,_1fd);
},getFrameSpecificPrototypePref:function(_1fe,_1ff,key){
var _200=rabbit.facade.getPrototypePref(key);
if(_200[_1fe]&&_200[_1fe][_1ff]){
return _200[_1fe][_1ff];
}else{
return null;
}
},sendMessage:function(url,data,_201){
if(rabbit.communication&&rabbit.communication.manager&&rabbit.communication.manager.sendMessage){
rabbit.communication.manager.sendMessage(url,data,_201);
}
}};
rabbit.result={};
rabbit.ui={};
...
rabbit.plugins={};
rabbit.stencils={};
rabbit.util=_.extend(rabbit.util,{formatDate:function(_202){
var diff=((new Date()).getTime()-_202)/1000/60;
var date=new Date(_202);
if(diff<2){
...
},isElementChildOfSelector:function(_203,_204){
return $(_203).parents(_204).length>0;
},userRole:null});
...
var _205={};
var _206={};
return {registerOnEvent:function registerOnEvent(_207,_208,_209,_20a){
if(typeof _207!=="string"||typeof _208!=="function"||typeof _209!=="object"){
throw "Invalid Arguments for registerOnEvent";
}
if(!_205.hasOwnProperty(_207)){
_205[_207]=[];
}
var data={"callback":_208,"thisArg":_209,"includeEventType":false};
if(_20a){
data.includeEventType=true;
}
_205[_207].push(data);
},registerOnCategoryEvent:function(_20b,_20c,_20d){
if(typeof _20b!=="string"||typeof _20c!=="function"||typeof _20d!=="object"){
throw "Invalid Arguments for registerOnEventForCategory";
}
if(!_206.hasOwnProperty(_20b)){
_206[_20b]=[];
}
var data={"callback":_20c,"thisArg":_20d,"includeEventType":true};
_206[_20b].push(data);
console.log("ok for "+_20b);
},raiseEvent:function raiseEvent(_20e){
this._raiseCategoryEvent.apply(this,arguments);
this._raiseNormalEvent.apply(this,arguments);
},_raiseCategoryEvent:function raiseEvent(_20f){
var _210=_20f.replace(/\..*$/,"");
if(_210!=_20f){
console.log("Try to raise catergory "+_210);
var _211=_206[_210];
if(typeof _211==="undefined"){
console.warn("No handler category for invoked eventType "+_20f+" (category: "+_210+")");
return;
}
for(var i=0;i<_211.length;i++){
try{
var args=Array.prototype.slice.call(arguments);
this._raiseEvent(_211[i],args);
}
catch(e){
console.error(e);
}
...
},_raiseNormalEvent:function raiseEvent(_212){
var _213=_205[_212];
if(typeof _213==="undefined"){
console.warn("No handler for invoked eventType "+_212);
return;
}
for(var i=0;i<_213.length;i++){
try{
var args=Array.prototype.slice.call(arguments);
this._raiseEvent(_213[i],args);
}
catch(e){
console.error(e);
}
}
},_raiseEvent:function(_214,args){
var _215=_214.callback;
var _216=_214.thisArg;
var _217=_214.includeEventType;
...
},buildEditUrl:function(_218){
var _219="/rabbit/edit/"+rabbit.result.manager.currentPrototypeId+"#";
var _21a="page/"+rabbit.result.manager.currentPageNr;
var _21b="";
if(_218){
var page=rabbit.data.pageStore.objects[_218];
var _21c=rabbit.data.folderStore.objects[page.data.parentFolder];
while(_21c!==undefined){
_21b="folder/"+_21c.data.id+"/"+_21b;
_21c=rabbit.data.folderStore.objects[_21c.data.parentFolder];
}
}
return _219+_21b+_21a;
},getUrl:function(name,_21d){
var url=this.urls[name];
var _21e=rabbit.result.manager.urlPattern;
...
if(name==="loadLayer"){
_21e=rabbit.result.manager.urlPattern.replace("__page__","layer/__page__");
}
url=url.replace("__urlPattern__",_21e);
if(_21d){
for(var key in _21d){
url=url.replace("__"+key+"__",_21d[key]);
}
}
return url;
},sendMessage:function(url,data,_21f){
this.post(rabbit.common.baseUrl+url,undefined,data,{complete:_21f});
},get:function(url,_220,data,_221){
return this.ajax(url,"get",_220,data,_221);
},post:function(url,_222,data,_223){
return this.ajax(url,"post",_222,data,_223);
},ajax:function(url,type,_224,data,_225){
if(!url){
...
data=data||undefined;
_225=_225||{};
var _226=_.defaults({url:url,type:type,dataType:_224,data:data},_225);
return $.ajax(_226);
}};
rabbit.result.manager={datePickerClicked:false,customDatepickerObjects:[],init:function(_227,_228,_229,_22a){
try{
...
rabbit.prototypeType=_228;
rabbit.browser=_229;
this.initialPageId=_227;
...
var page=rabbit.data.pageStore.objects[_227];
...
try{
var _22b=rabbit.facade._availablePlugins[i];
_22b.init.apply(_22b,_22b._initialArguments);
}
catch(e){
console.error(e);
}
...
},goToPage:function(_22c,_22d){
var url;
var page=rabbit.data.pageStore.objects[_22c];
var _22e=Boolean(page);
if(_22e){
url=page.getUrl();
...
if(!_22c.match(/^[a-zA-Z0-9]*:\/\//)){
url="http://"+_22c;
}else{
url=_22c;
}
}
if(!_22e&&rabbit.facade.runningInApp()&&rabbit.facade.isIOS){
...
},showPage:function(_22f,_230,_231,_232){
_231=_231||false;
var _233=_22f.attr("id");
try{
if(_230===""||_230===this.currentPageNr){
return;
}
var page=rabbit.data.pageStore.objects[_230];
console.log("show page repository:"+_233+" page:"+_230,page);
if(page===undefined){
this.goToPage(_230);
return;
}
rabbit.ui.manager.showPage(_22f,_230,_232);
if(_231===true&&this.isPushStateAvailable){
console.log("PUSH STATE",_230);
window.history.pushState({repositoryId:_233,pageId:_230},"",page.getUrl());
}
this.currentPageNr=_230;
_22f.data("page-id",_230);
rabbit.event.manager.raiseEvent(rabbit.events.pageLoaded,page,_22f);
rabbit.mobile.trigger("pidoco:afterShowPage");
}
catch(e){
console.error(e);
}
},menuClick:function(a,b,_234){
rabbit.result.manager.goToPage(_234,false);
}};
...
},createWrappers:function(_235,_236,_237){
var _238=$("<div class=\"wrapper wrapper-"+_236+"\" data-layer-id=\""+_236+"\" style=\"display: none\"></div>").appendTo(_235);
var page=rabbit.data.pageStore.objects[_236];
if(_237===true&&page){
for(var name in page.data.layers){
if(page.data.layers[name]===true||page.data.layers[name]==="true"){
this.createWrappers(_235,name);
}
}
}
return _238;
},fillWrappersWithLayer:function(_239){
var _23a=_239.data.id;
$(".wrapper-"+_23a+"[data-fill-me=\"true\"]:empty").each(function(_23b,_23c){
this.fillWrapperWithLayer(_23c,_239);
_23c.removeAttribute("data-fill-me");
}.bind(this));
},fillWrapperWithLayer:function(_23d,_23e,_23f){
var _240=_23e.data.html;
var _241=_23d.parentNode.id;
var html=_23e.data.html;
if(html){
html=$(_23e.data.html.replace(/__containerId__/g,_241));
if(_23f){
html.find("script").remove();
}
$(_23d).append(html);
if(!this.inTransition){
rabbit.facade.raiseEvent(rabbit.events.layerStoreInserted,_23d.children[0]);
}
}else{
_23d.setAttribute("data-fill-me","true");
}
return html;
},getLayerWrapper:function(_242,_243){
return _242.find(">.wrapper-"+_243);
},showLayer:function(_244,_245){
var _246=rabbit.data.layerStore.objects[_245];
if(!_246){
_246=rabbit.data.layerStore.loadLayer(_245);
}
var _247=this.getLayerWrapper(_244,_245);
if(!_247.length){
_247=this.createWrappers(_244,_245,true);
}
if(_247[0].children.length===0){
this.fillWrapperWithLayer(_247[0],_246);
}
_247.show();
rabbit.event.manager.raiseEvent(rabbit.events.showLayer,{id:_244.attr("id")+_245,layerId:_245,repositoryId:_244.attr("id")});
},hideLayer:function(_248,_249){
var _24a=this.getLayerWrapper(_248,_249);
_24a.hide();
rabbit.event.manager.raiseEvent(rabbit.events.hideLayer,{id:_248.attr("id")+_249,layerId:_249,repositoryId:_248.attr("id")});
},toggleLayer:function(_24b,_24c){
var _24d=this.getLayerWrapper(_24b,_24c);
if(!_24d.length||_24d.css("display")==="none"){
return this.showLayer(_24b,_24c);
}else{
return this.hideLayer(_24b,_24c);
}
},showPage:function(_24e,_24f,_250){
var _251;
if(_250==="fromRight"||_250==="fromLeft"||_250==="fromTop"||_250==="fromBottom"){
_251=this.showPageWithTranslation(_24e,_24f,_250);
}else{
if(_250==="opacity"){
_251=this.showPageWithOpacity(_24e,_24f);
}else{
if(_250==="flip"){
_251=this.showPageWithFlip(_24e,_24f);
}else{
_251=this.showPageWithoutTransition(_24e,_24f);
}
}
}
if(_24e.attr("id")=="repository"&&_251){
_251.done(function(){
$(_24e).attr("data-review-reference-id",_24f);
$(_24e).attr("data-page-id",_24f);
$("body").attr("data-current-page-id",_24f);
});
}
},showPageWithoutTransition:function(_252,_253){
var page=rabbit.data.pageStore.objects[_253];
var _254=new $.Deferred();
rabbit.ui.manager.showLayer(_252,_253);
_.each(page.data.layers,function(_255,_256){
this.showLayer(_252,_256);
}.bind(this));
_252.find(">.wrapper").each(function(_257,_258){
var _259=_258.getAttribute("data-layer-id");
if((!page.data.layers.hasOwnProperty(_259)||page.data.layers[_259]!==true)&&_259!=_253){
this.hideLayer(_252,_259);
}
}.bind(this));
_254.resolve();
return _254.promise();
},showPageWithFlip:function(_25a,_25b){
var _25c=500;
var _25d=new $.Deferred();
this.startTransition(_25a);
var _25e=this.createTransitionWrapper(_25a,_25b);
var _25f=_25e.leave.find(">div");
var _260=_25e.enter.find(">div");
_25a.find(">div").hide();
_25a.append(_25e.leave).append(_25e.enter);
_260.hide();
_25f.transition({perspective:"0px",rotateY:"90deg",duration:_25c},function(){
_260.transition({perspective:"0px",rotate3d:"0,1,0,270deg",duration:0},function(){
_260.show();
this.showPageWithoutTransition(_260,_25b);
_260.transition({perspective:"0px",rotate3d:"0,1,0,360deg",duration:_25c},function(){
_25f.transition({perspective:"0px",rotateY:"0deg",duration:0},function(){
this.stopTransition(_25a);
this.showPageWithoutTransition(_25a,_25b);
_25e.leave.remove();
_25e.enter.remove();
_25d.resolve();
}.bind(this));
...
return _25d.promise();
},showPageWithOpacity:function(_261,_262){
var _263=500;
var _264=new $.Deferred();
this.startTransition(_261);
var _265=this.createTransitionWrapper(_261,_262);
var _266=_265.leave.find(">div");
var _267=_265.enter.find(">div");
_261.find(">div").hide();
_261.append(_265.leave).append(_265.enter);
_267.css({opacity:0});
_266.transition({opacity:0,duration:_263},function(){
this.showPageWithoutTransition(_267,_262);
_267.transition({opacity:1,duration:_263},function(){
this.stopTransition(_261);
this.showPageWithoutTransition(_261,_262);
_265.leave.remove();
_265.enter.remove();
_264.resolve();
}.bind(this));
...
return _264.promise();
},showPageWithTranslation:function(_268,_269,_26a){
var _26b=_268.width();
var _26c=_268.height();
var _26d=500;
var _26e=new $.Deferred();
this.startTransition(_268);
var _26f=this.createTransitionWrapper(_268,_269);
var _270=_26f.leave.find(">div");
var _271=_26f.enter.find(">div");
if(_26a==="fromLeft"){
_271.css("left",-1*_26b);
}else{
if(_26a==="fromTop"){
_271.css("top",-1*_26c);
}else{
...
_271.find(">div").show();
_268.find(">div").hide();
_268.append(_26f.leave).append(_26f.enter);
var _272=function(){
this.stopTransition(_268);
this.showPageWithoutTransition(_268,_269);
_26f.leave.remove();
_26f.enter.remove();
_26e.resolve();
}.bind(this);
if(_26a==="fromLeft"){
_270.transition({x:_26b+"px",duration:_26d});
_271.transition({x:_26b+"px",duration:_26d},_272);
}else{
if(_26a==="fromTop"){
_270.transition({y:_26c+"px",duration:_26d});
_271.transition({y:_26c+"px",duration:_26d},_272);
}else{
if(_26a==="fromBottom"){
_270.transition({y:"-"+_26c+"px",duration:_26d});
_271.transition({y:"-"+_26c+"px",duration:_26d},_272);
...
return _26e.promise();
},createTransitionWrapper:function(_273,_274){
var _275=_273.data("page-id");
var _276=rabbit.data.pageStore.objects[_274];
var _277=rabbit.data.pageStore.objects[_275];
var _278,_279;
var _27a=$("<div class=\"transition-wrapper transition-enter\" data-page-id=\""+_274+"\"><div class=\"layer-container\"></div></div>");
var _27b=$("<div class=\"transition-wrapper transition-leave\" data-page-id=\""+_275+"\"><div class=\"layer-container\"></div></div>");
var _27c=_27b.find(">div");
var _27d=_27a.find(">div");
var _27e=_273.find(".wrapper-"+_275).clone().remove("script");
var _27f=_273.find(".wrapper-"+_274).clone().remove("script");
for(_278 in _276.data.layers){
_279=_276.data.layers[_278];
if(_279===true||_279==="true"){
this.createWrappers(_27d,_278,false);
this.showLayer(_27d,_278);
}
}
for(_278 in _277.data.layers){
_279=_277.data.layers[_278];
if(_279===true||_279==="true"){
this.createWrappers(_27c,_278,false);
this.showLayer(_27c,_278);
}
}
_27c.append(_27e);
if(_27f.length===0){
_27f=this.createWrappers(_27d,_274,true);
}else{
_27d.append(_27f);
}
if(_27f.children().length===0){
this.fillWrapperWithLayer(_27f[0],rabbit.data.layerStore.objects[_274],true);
}
return {enter:_27a,leave:_27b};
},startTransition:function(_280){
this.inTransition=true;
$("body").addClass("disable-pointer-events");
$(_280).addClass("during-transition");
},stopTransition:function(_281){
this.inTransition=false;
$("body").removeClass("disable-pointer-events");
$(_281).removeClass("during-transition");
},_forceRedraw:function(){
var _282=navigator.userAgent.toLowerCase().indexOf("chrome")>-1;
var _283=navigator.userAgent.toLowerCase().indexOf("safari")>-1;
if(_282||_283){
...
rabbit.interaction.manager={tmp:{},actions:{click:{makeableOnDesktop:function(_284){
return !_284.numberOfFinger||_284.numberOfFinger=="1"||_284.numberOfFinger=="any";
},render:function(_285){
if(parseInt(_285.data.action.numberOfFinger,10)>1){
return t("interaction.action.multiFingerClick.userDescription").replace("__element__",rabbit.interaction.manager.getElementTitle(_285));
}else{
return t("interaction.action.click.userDescription").replace("__element__",rabbit.interaction.manager.getElementTitle(_285));
}
},defineEvent:function(_286){
var _287=document.getElementById(_286.data.stencilId);
if(_286.data.action.button=="right"){
$(_287).on("contextmenu",function(e){
rabbit.interaction.manager.raiseInteraction(_286,rabbit.interaction.manager.serializeEvent(e));
return false;
});
}else{
if(false){
...
var _28a=200;
var _28b=500;
_287.addEventListener("touchstart",function(e){
if(!_286.data.action.numberOfFinger||(_286.data.action.numberOfFinger&&(_286.data.action.numberOfFinger==="any"||parseInt(_286.data.action.numberOfFinger,10)===e.touches.length))){
_288=new Date().getTime();
}
e.preventDefault();
},false);
_287.addEventListener("touchend",function(e){
if(_288){
...
if(rabbit.interaction.manager.actions.click.makeableOnDesktop(_286.data.action)){
_287.addEventListener("click",function(e){
rabbit.interaction.manager.raiseInteraction(_286,rabbit.interaction.manager.serializeEvent(e));
});
}
}
}
}},doubleClick:{makeableOnDesktop:true,render:function(_28c){
return t("interaction.action.doubleClick.userDescription").replace("__element__",rabbit.interaction.manager.getElementTitle(_28c));
},defineEvent:function(_28d){
var _28e=document.getElementById(_28d.data.stencilId);
if(_28d.data.action.button=="right"){
$(_28e).on("contextmenu",function(e){
rabbit.interaction.manager.raiseInteraction(_28d,rabbit.interaction.manager.serializeEvent(e));
return false;
});
}else{
if(false){
...
var _291=200;
var _292=500;
_28e.addEventListener("touchstart",function(e){
_28f=new Date().getTime();
if(_292<(_28f-_290)){
_290=null;
}
e.preventDefault();
},false);
_28e.addEventListener("touchend",function(e){
if(_28f){
var end=new Date().getTime();
if(_291>(end-_28f)){
if(!_290){
...
_28e.addEventListener("dblclick",function(e){
rabbit.interaction.manager.raiseInteraction(_28d,rabbit.interaction.manager.serializeEvent(e));
});
}
}
}},hover:{makeableOnDesktop:true,render:function(_293){
return t("interaction.action.hover.userDescription").replace("__element__",rabbit.interaction.manager.getElementTitle(_293));
},defineEvent:function(_294){
if(!_294.data.action.trigger){
_294.data.action.trigger="enter";
}
if(_294.data.action.trigger=="both"||_294.data.action.trigger=="enter"){
$("#"+_294.data.stencilId).on("mouseenter",function(e){
rabbit.interaction.manager.raiseInteraction(_294,rabbit.interaction.manager.serializeEvent(e));
});
}
if(_294.data.action.trigger=="both"||_294.data.action.trigger=="leave"){
$("#"+_294.data.stencilId).on("mouseleave",function(e){
rabbit.interaction.manager.raiseInteraction(_294,rabbit.interaction.manager.serializeEvent(e));
});
}
}},swipe:{makeableOnDesktop:false,render:function(_295){
return t("interaction.action.swipe.userDescription").replace("__element__",rabbit.interaction.manager.getElementTitle(_295));
},defineEvent:function(_296){
var _297=Hammer(document.getElementById(_296.data.stencilId),{swipe_max_touches:5,drag_block_horizontal:true,drag_block_vertical:true,swipe_velocity:0.4});
_297.on("swipe",function(e){
if(_296.data.action.direction==="any"||e.gesture.direction===_296.data.action.direction){
rabbit.facade.markHighlightTouchesAsSuccessful();
rabbit.interaction.manager.raiseInteraction(_296,rabbit.interaction.manager.serializeEvent(e));
}
});
}},pinch:{makeableOnDesktop:false,render:function(_298){
return t("interaction.action.pinch.userDescription").replace("__element__",rabbit.interaction.manager.getElementTitle(_298));
},defineEvent:function(_299){
var _29a=Hammer(document.getElementById(_299.data.stencilId),{prevent_default:true});
var _29b=null;
var _29c=false;
if(_299.data.action.direction==="in"){
_29b="pinchin";
}else{
if(_299.data.action.direction==="out"){
_29b="pinchout";
}else{
_29b="pinch";
}
}
_29a.on("transformstart",function(e){
_29c=false;
});
_29a.on("transformend",function(e){
if(_29c){
rabbit.facade.markHighlightTouchesAsSuccessful();
rabbit.interaction.manager.raiseInteraction(_299,rabbit.interaction.manager.serializeEvent(e));
}
});
_29a.on(_29b,function(e){
_29c=true;
});
}}},getInterinteractionEventId:function(_29d){
return "interaction."+_29d;
},raiseInteraction:function(_29e,e){
if(this.isInteractionExecutable(_29e)){
rabbit.facade.raiseEvent(_29e.data.uniqueId,e);
return true;
}else{
return false;
}
},isLayerHidden:function(_29f){
return $(_29f).css("display")==="none";
},isInteractionExecutable:function(_2a0){
var _2a1=$("#"+_2a0.data.stencilId);
var _2a2=_2a1.parents(".layer");
for(var i=0;i<_2a2.length;i++){
if(this.isLayerHidden(_2a2.get(i))){
return false;
}
}
if(_2a1.length===0||_2a1.hasClass("layer")&&this.isLayerHidden(_2a1)){
return false;
}
return true;
},renderAction:function(_2a3){
return rabbit.interaction.manager.actions[_2a3.data.action.type].render(_2a3);
},getElementTitle:function(_2a4){
var type=$("#"+_2a4.data.stencilId).data("interactive-element-type");
return t("stencils."+type+"-palette");
},registerAction:function(name,_2a5){
if(_.has(rabbit.interaction.manager.actions,name)){
throw "Action with name "+name+" already exists.";
}else{
rabbit.interaction.manager.actions[name]=_2a5;
}
},registerReaction:function(name,_2a6){
if(_.has(rabbit.interaction.manager.reactions,name)){
throw "Action with name "+name+" already exists.";
}else{
rabbit.interaction.manager.reactions[name]=_2a6;
}
},reactions:{showPage:{init:function(_2a7,_2a8){
var _2a9=rabbit.interaction.manager.reactions.showPage.getOpeningMethod(_2a8);
if(rabbit.data.pageStore.objects[_2a8.target]&&(_2a9==="withoutReloadOnly"||_2a9==="withoutReloadIframe")){
rabbit.facade.loadLayer(_2a8.target);
}
},getOpeningMethod:function(_2aa){
var _2ab=_2aa.options;
if(!_2ab){
if(_2aa.inNewTab==="true"){
_2ab="reloadNewTab";
}else{
if(_2aa.withoutReload=="true"){
_2ab="withoutReloadOnly";
}else{
if(_2aa.withoutReload!==undefined){
_2ab="reloadOnly";
}
}
}
...
return _2ab;
},callback:function(_2ac,_2ad,_2ae){
var _2af=_2ae.target;
if(!_2af){
return;
}
var _2b0=rabbit.interaction.manager.reactions.showPage.getOpeningMethod(_2ae);
if(_2b0==="reloadNewTab"){
rabbit.result.manager.goToPage(_2af,true);
}else{
if(_2b0==="withoutReloadOnly"){
rabbit.facade.showPage($("#repository"),_2af,true,_2ae.transition);
}else{
if(_2b0==="withoutReloadIframe"){
var _2b1=document.getElementById(_2ad.data.stencilId);
var _2b2=rabbit.facade.getRepositoryFromStencil(_2b1);
var _2b3=false;
if(_2b2.attr("id")==="repository"){
_2b3=true;
}
rabbit.facade.showPage(_2b2,_2af,_2b3,_2ae.transition);
}else{
rabbit.result.manager.goToPage(_2af);
}
}
}
}},toggleLayer:{init:function(_2b4,_2b5){
rabbit.facade.loadLayer(_2b5.layer);
},callback:function(_2b6,_2b7,_2b8){
var _2b9=document.getElementById(_2b7.data.stencilId);
var _2ba=rabbit.facade.getRepositoryFromStencil(_2b9);
if(_2b8.visibility==="toggle"){
rabbit.facade.toggleLayer(_2ba,_2b8.layer);
}else{
if(_2b8.visibility==="show"){
rabbit.facade.showLayer(_2ba,_2b8.layer);
}else{
if(_2b8.visibility==="hide"){
rabbit.facade.hideLayer(_2ba,_2b8.layer);
}
}
}
}},vibrate:{callback:function(_2bb,_2bc,_2bd){
navigator.vibrate=navigator.vibrate||navigator.mozVibrate||navigator.webkitVibrate||undefined;
if(navigator.vibrate){
navigator.vibrate(_2bd.duration);
}else{
if(window.parentBody){
window.parentBody.trigger("pidoco:vibrate",[{duration:_2bd.duration}]);
}else{
}
}
}},browserBack:{callback:function(_2be,_2bf,_2c0){
rabbit.facade.browserBack();
}},browserForward:{callback:function(_2c1,_2c2,_2c3){
rabbit.facade.browserForward();
}},closeBrowserWindow:{callback:function(_2c4,_2c5,_2c6){
rabbit.facade.closeBrowserWindow();
}}},registerInteraction:function(_2c7,_2c8,_2c9,_2ca){
if(_2c7[0]==="-"){
return;
}
if(!_.isArray(_2ca)){
...
var _2cb=new rabbit.data.Interaction(_2c7,_2c8,_2c9,_2ca);
_2cb.initializeAction();
_2cb.initializeReactions();
rabbit.facade.raiseEvent(rabbit.events.newInteractionRegistered,_2cb);
},serializeEvent:function(e){
return {};
}};
rabbit.mobile={bind:function(_2cc,_2cd){
if(rabbit.facade.runningInApp()){
document.addEventListener(_2cc,_2cd);
}
},unbind:function(_2ce,_2cf){
if(rabbit.facade.runningInApp()){
document.removeEventListener(_2ce,_2cf);
}
},trigger:function(_2d0,data){
if(rabbit.facade.runningInApp()){
window.parentBody.trigger(_2d0,data);
}
}};
rabbit.facade=_.extend(rabbit.facade,function _returnFacade(){
var _2d1=rabbit.event.manager;
return {_availablePlugins:[],vml:false,isIOS:navigator.userAgent.match(/iPad|iPhone/),isAndroid:navigator.userAgent.match(/Android/),scaleFactor:1,registerPlugin:function registerPlugin(_2d2,_2d3){
try{
var _2d4=Array.prototype.slice.call(arguments);
_2d4.shift();
_2d2._initialArguments=_2d4;
this._availablePlugins.push(_2d2);
}
catch(e){
console.log(e);
}
},setScaleFactor:function(_2d5){
this.scaleFactor=_2d5;
},getScaleFactor:function(){
return this.scaleFactor;
},isFrameDisplayed:false,registerOnEvent:function registerOnEvent(_2d6,_2d7,_2d8){
try{
if(_.isArray(_2d6)){
for(var i=0;i<_2d6.length;i++){
console.debug("Registering a handler for "+_2d6[i]);
_2d1.registerOnEvent(_2d6[i],_2d7,_2d8,true);
}
}else{
if(_.isString(_2d6)){
console.debug("Registering a handler for "+arguments[0]);
_2d1.registerOnEvent(_2d6,_2d7,_2d8,false);
}
}
}
catch(e){
...
},registerOnCategoryEvent:function(_2d9,_2da,_2db){
try{
_2d1.registerOnCategoryEvent(_2d9,_2da,_2db,true);
}
catch(e){
console.error(e);
return undefined;
}
},raiseEvent:function raiseEvent(_2dc){
console.debug("Raising a "+arguments[0]+" event");
try{
return _2d1.raiseEvent.apply(_2d1,arguments);
}
catch(e){
console.error(e);
return undefined;
}
},fireMouseOn:function fireMouseOn(_2dd){
var _2de=document.getElementById(_2dd);
if(_2de===null){
return;
}
console.debug("Forwarding a click event to "+_2dd);
_2de.click();
_2de.focus();
},showPage:function(){
...
window.close();
},getLayerFromStencil:function(_2e0){
return $(_2e0).closest(".layer");
},getRepositoryFromStencil:function(_2e1){
return $(_2e1).closest(".repository");
},isExport:function(){
...
},"alert":function(_2e5,text,_2e6){
rabbit.plugins.systemAlert.alert(_2e5,text,_2e6);
}};
}());
...
},loadLayer:function(_2e7){
if(typeof this.objects[_2e7]==="undefined"){
var url=null;
if(rabbit.result.manager.isExport){
var _2e8=(rabbit.browser==="ie")?"-ie":"";
url=rabbit.communication.manager.getUrl("loadLayerExport",{layerId:_2e7,browser:_2e8,mode:rabbit.util.getMode()});
}else{
url=rabbit.communication.manager.getUrl("loadLayer",{prototypeId:rabbit.result.manager.currentPrototypeId,layer:_2e7});
}
var _2e9=(rabbit.result.manager.isExport)?"jsonp":"html";
var ajax=rabbit.communication.manager.get(url,_2e9,{containerId:"__containerId__",mode:rabbit.util.getMode(),viewMode:rabbit.parameters.viewMode,fontFamily:rabbit.parameters.fontFamily},{crossDomain:rabbit.result.manager.isExport});
if(!rabbit.result.manager.isExport){
ajax.done(this.addLayerFromHtml.bind(this));
}
this.objects[_2e7]=new rabbit.data.Layer(_2e7,null,null);
}
return this.objects[_2e7];
},addLayerFromHtml:function(html){
layerElements=$($.trim(html));
$(layerElements).children().each(function(_2ea,_2eb){
_2eb=$(_2eb);
var _2ec=_2eb.data("layer-id");
var _2ed=_2eb.data("layer-type");
var html=$.trim(_2eb[0].outerHTML);
if(this.objects[_2ec]){
this.objects[_2ec].data.id=_2ec;
this.objects[_2ec].data.layerType=_2ed;
this.objects[_2ec].data.html=html;
}else{
this.objects[_2ec]=new rabbit.data.Layer(_2ec,_2ed,html);
}
rabbit.facade.raiseEvent(rabbit.events.layerLoaded,this.objects[_2ec]);
}.bind(this));
}};
rabbit.data.Layer=rabbit.util.Class(rabbit.data.Base,function(sup){
this.init=function(id,_2ee,html){
this.data={id:id,layerType:_2ee,html:html};
};
});
rabbit.data.pageStore={objects:{},init:function(){
var _2ef=$("#pageNames").html();
if((_2ef!==null)&&(_2ef!=="__pageNames__")){
_2ef=JSON.parse(_2ef);
}
var _2f0=rabbit.data.raw.pages;
for(var id in _2f0){
this.objects[id]=new rabbit.data.Page(_.extend(_2f0[id],{id:id}));
this.objects[id].data.pageName=_2ef[id];
}
...
var _2f1=rabbit.data.raw.folders;
for(var id in _2f1){
this.objects[id]=new rabbit.data.Folder(_.extend(_2f1[id],{id:id}));
}
...
this.init=function(_2f2,_2f3,_2f4,_2f5){
this.data={stencilId:_2f2,interactionId:_2f3,uniqueId:_2f2+"-"+_2f3,action:_2f4,reactions:_2f5};
};
...
_.each(this.data.reactions,function(_2f6){
if(!_.has(rabbit.interaction.manager.reactions,_2f6.type)){
console.error("Reaction \""+_2f6.type+"\" is not supported");
return;
}
var init=rabbit.interaction.manager.reactions[_2f6.type].init;
if(typeof init==="function"){
init(this,_2f6);
}
}.bind(this));
rabbit.facade.registerOnEvent(this.data.uniqueId,function(e){
_.each(this.data.reactions,function(_2f7){
var _2f8=parseInt(_2f7.delay,10)||0;
setTimeout(function(){
rabbit.interaction.manager.reactions[_2f7.type].callback(e,this,_2f7);
}.bind(this),_2f8);
}.bind(this));
...
},createDiscussion:function(_2f9,_2fa,x,y,data){
var url=rabbit.communication.manager.getUrl("createDiscussion",{layerId:_2f9});
data=data||{};
data=_.defaults(data,{title:_2fa,x:x,y:y,pageX:x,pageY:y,referenceId:rabbit.facade.getCurrentPageId(),pageId:rabbit.facade.getCurrentPageId(),layerContainerId:rabbit.facade.getCurrentPageId()});
return rabbit.data.discussionStore.callAjax(url,data);
},deleteDiscussion:function(_2fb){
delete this.objects[_2fb.data.id];
var url=rabbit.communication.manager.getUrl("deleteDiscussion",{layerId:_2fb.data.layerId});
return this.callAjax(url,{discussion:_2fb.data.id});
},flush:function(){
this.objects={};
rabbit.event.manager.raiseEvent(rabbit.events.discussionStoreChanged);
},getFromLayer:function(_2fc){
var url=rabbit.communication.manager.getUrl("getDiscussions",{layerId:_2fc});
...
var _2fd=this.objects[id];
if(_2fd){
_2fd.setData(data.discussions[id]);
}else{
_2fd=new rabbit.data.Discussion();
_2fd.setData(data.discussions[id]);
this.objects[id]=_2fd;
}
}
...
this.move=function(x,y,_2fe,_2ff,_300,_301,_302,_303){
this.data.x=x;
this.data.y=y;
this.data.pageX=_2fe;
this.data.pageY=_2ff;
this.data.referenceId=_300;
this.data.pageId=_301;
this.data.layerId=_302;
this.data.layerContainerId=_303;
var url=rabbit.communication.manager.getUrl("moveDiscussion",{layerId:this.data.layerId});
return rabbit.data.discussionStore.callAjax(url,{discussion:this.data.id,x:Math.floor(x),y:Math.floor(y),pageX:Math.floor(_2fe),pageY:Math.floor(_2ff),referenceId:_300,pageId:_301,layerId:_302,layerContainerId:_303});
};
this.rename=function(_304){
if(this.data.title===_304){
return;
}
var _305=this.data.title;
this.data.title=_304;
...
var _306=t("result.discussion.title-changed").replace("__oldTitle__",_305).replace("__newTitle__",_304);
this.addEntry(_306);
return ajax;
};
...
this.setState=function(_307){
var url=rabbit.communication.manager.getUrl("setStateDiscussion",{layerId:this.data.layerId});
return rabbit.data.discussionStore.callAjax(url,{discussion:this.data.id,state:_307});
};
});
...
var _308=rabbit.facade;
return {init:function init(){
},adjustBackgroundImage:function adjustBackgroundImage(_309){
var _30a=document.getElementById("borderDiv");
_30a.style.width=_309.data.width+"px";
_30a.style.height=_309.data.height+"px";
var _30b=document.getElementById("repositorybackground");
_30b.setAttribute("width",_309.data.width);
_30b.setAttribute("height",_309.data.height);
_30b.setAttribute("style","width:"+_309.data.width+"px;height:"+_309.data.height+"px;");
this._replaceBackgroundImage(_309);
},_replaceBackgroundImage:function _replaceBackgroundImage(_30c){
var _30d,_30e;
if(!_308.vml){
_30d=document.getElementById("repositorybackground");
_30e=_30d.getElementsByTagNameNS("http://www.w3.org/2000/svg","image")[0];
_30e.setAttribute("width",_30c.data.width);
_30e.setAttribute("height",_30c.data.height);
if(_30c.data.image!==""){
_30e.setAttribute("display","inherit");
_30e.setAttributeNS("http://www.w3.org/1999/xlink","href",_30c.data.image);
}else{
_30e.setAttribute("display","none");
_30e.removeAttributeNS("http://www.w3.org/1999/xlink","href");
}
}else{
_30d=document.getElementById("repositorybackground");
_30e=document.createElement("img");
_30e.style.width="";
_30e.style.height="";
_30e.setAttribute("src",_30c.data.image.replace(/_(\d)+\Z/,""));
_30d.replaceChild(_30e,_30d.firstChild);
if(_30c.data.image===""){
_30e.style.display="none";
}else{
_30e.style.display="inline";
this._adjustBackgroundImgSize(_30c.data.width,_30c.data.height);
}
}
},_adjustBackgroundImgSize:function _adjustBackgroundImgSize(_30f,_310){
if(!document.images[0].complete){
window.setTimeout("rabbit.plugins.background._adjustBackgroundImgSize("+_30f+", "+_310+");",100);
return;
}
var _311=document.images[0].width;
var _312=document.images[0].height;
if(_311/_312>_30f/_310){
document.images[0].width=_30f;
document.images[0].height=_312*_30f/_311;
}else{
document.images[0].width=_311*_310/_312;
document.images[0].height=_310;
}
}};
}();
rabbit.facade.registerPlugin(rabbit.plugins.background);
rabbit.plugins.gps=function(){
var _313=rabbit.facade;
var _314={};
var _315=[];
var _316={nyc:{latitude:40.714353,longitude:-74.005973},paris:{latitude:48.856614,longitude:2.352222},pidoco:{latitude:52.509561,longitude:13.451579},warschauer60:{latitude:52.509754,longitude:13.451715},alexanderplatz:{latitude:52.521832,longitude:13.413168}};
return {trackPositionWithJavaScript:true,trackPosition:false,init:function init(){
this.startTrackPositon();
_313.registerOnEvent("positionChanged",this.positionChanged,this);
_313.registerAction("gps",{availableOnDesktop:false,init:function(){
rabbit.plugins.gps.trackPosition=true;
},render:function(_317){
if(_317.trigger==="both"){
return t("interaction.action.gps.userDescription.both");
}else{
if(_317.trigger==="enter"){
return t("interaction.action.gps.userDescription.enter");
}else{
if(_317.trigger==="leave"){
return t("interaction.action.gps.userDescription.leave");
}
}
}
},defineEvent:function(_318){
var area=JSON.parse(_318.data.action.area);
rabbit.plugins.gps.registerMoveInOutZone(area.latitude,area.longitude,area.distance,_318.data.action.trigger,function(e){
rabbit.interaction.manager.raiseInteraction(_318,e);
});
}});
...
navigator.geolocation.getCurrentPosition(function(_31c){
rabbit.plugins.gps.positionChanged(_31c.coords);
_319=setInterval(_31b,_31a);
},function(){
console.log("ERROR GPS!");
},{maximumAge:_31a,enableHighAccuracy:true,timeout:10000});
}
clearInterval(_319);
}
};
...
this.positionChanged({latitude:_316[name].latitude,longitude:_316[name].longitude});
},registerMoveInOutZone:function(_31d,_31e,_31f,_320,_321){
_315.push({latitude:_31d,longitude:_31e,distance:_31f,callback:_321,trigger:_320,wasInArea:false});
},positionChanged:function(_322){
for(var i=0;i<_315.length;i++){
var area=_315[i];
var _323=this.isPositionInArea(_322,area);
if(_323&&!area.wasInArea&&area.trigger==="enter"||!_323&&area.wasInArea&&area.trigger==="leave"||_323!==area.wasInArea&&area.trigger==="both"){
area.callback();
}
area.wasInArea=_323;
}
},isPositionInArea:function(_324,area){
return this.calculateDistance(_324.latitude,_324.longitude,area.latitude,area.longitude)<area.distance;
},calculateDistance:function(lat1,lon1,lat2,lon2){
var _325=function(deg){
return deg*(Math.PI/180);
};
var R=6371;
var dLat=_325(lat2-lat1);
var dLon=_325(lon2-lon1);
var a=Math.sin(dLat/2)*Math.sin(dLat/2)+Math.cos(_325(lat1))*Math.cos(_325(lat2))*Math.sin(dLon/2)*Math.sin(dLon/2);
...
var _326=rabbit.facade;
return {init:function(){
_326.registerAction("keypress",{makeableOnDesktop:true,render:function(_327){
return t("interaction.action.keypress.userDescription");
},defineEvent:function(_328){
var _329=_328.data.action.sequence;
if(_329){
Mousetrap.bind(_329,function(){
rabbit.interaction.manager.raiseInteraction(_328,{});
});
}
}});
}};
...
var _32a=rabbit.facade;
return {audiofiles:{},audios:{},init:function(){
_32a.registerReaction("sound",{init:function(_32b,_32c){
var id=_32c.soundUploader;
...
},callback:function(_32d,_32e,_32f){
rabbit.plugins.sound.audiofiles[_32f.soundUploader].play();
if(_32f.duration!==""){
setTimeout(function(){
rabbit.plugins.sound.audiofiles[_32f.soundUploader].pause();
rabbit.plugins.sound.audiofiles[_32f.soundUploader].currentTime=0;
},_32f.duration);
}
}});
}};
...
var _330=rabbit.facade;
return {init:function(){
_330.registerReaction("systemAlert",{callback:function(_331,_332,_333){
this.alert(_333.title,_333.text,_333.buttonName);
}.bind(this)});
},alert:function(_334,text,_335){
if(_330.runningInApp()){
rabbit.facade.mobile.trigger("pidoco:systemAlert",{title:_334,text:text,buttonName:_335});
}else{
alert(text);
}
}};
...
var _336=rabbit.facade;
return {init:function(){
_336.registerAction("flip",{makeableOnDesktop:false,render:function(_337){
return t("interaction.action.flip.userDescription");
},defineEvent:function(_338){
new Fliptiltshake("flip",function(){
rabbit.interaction.manager.raiseInteraction(_338,{});
});
Fliptiltshake.start();
}});
}};
...
_339.registerAction("tilt",{makeableOnDesktop:false,render:function(_33a){
return t("interaction.action.tilt.userDescription");
},defineEvent:function(_33b){
new Fliptiltshake("tilt",{rotation:_33b.data.action.rotation,direction:(_33b.data.action.direction==="both")?null:_33b.data.action.direction,angle:_33b.data.action.angle,callback:function(){
if(rabbit.plugins.tilt.paused){
return;
}
var _33c=rabbit.interaction.manager.raiseInteraction(_33b,{});
if(_33c){
...
var _33d=rabbit.facade;
return {init:function(){
_33d.registerAction("shake",{makeableOnDesktop:false,render:function(_33e){
return t("interaction.action.shake.userDescription");
},defineEvent:function(_33f){
var _340=(_33d.isIOS)?_33f.data.action.intensity:_33f.data.action.intensity*10;
new Fliptiltshake("shake",{threshold:_340,durationMin:_33f.data.action.duration,callback:function(){
rabbit.interaction.manager.raiseInteraction(_33f,{});
}});
Fliptiltshake.start();
}});
}};
...
_341.registerAction("orientation",{makeableOnDesktop:false,render:function(_343){
var _344=_343.data.action;
if(_344.direction==="portrait"){
...
},defineEvent:function(_345){
_341.registerOnEvent("orientationChanged",function(_346){
if(_345.data.action.direction==_346){
rabbit.interaction.manager.raiseInteraction(_345,{});
}
},this);
}});
},orientationChanged:function(_347){
var _348=(_347===90||_347===-90)?"landscape":"portrait";
if(_342!=_348){
_342=_348;
_341.raiseEvent("orientationChanged",_348);
}
}};
}();
...
},frameChanged:function(_349,_34a){
var top=0,left=0;
if(rabbit.facade.isFrameDisplayed){
left=rabbit.common.frames[_349][_34a].frameBorderLeft;
top=rabbit.common.frames[_349][_34a].frameBorderTop;
}
this.container.css({left:left,top:top});
},newInteractionRegistered:function(_34b){
var _34c=_34b.data.action;
var _34d=typeof rabbit.interaction.manager.actions[_34c.type].makeableOnDesktop==="function"?rabbit.interaction.manager.actions[_34c.type].makeableOnDesktop(_34c):rabbit.interaction.manager.actions[_34c.type].makeableOnDesktop;
if(_34d){
return;
}
if(this.interactions[_34b.data.uniqueId]){
return;
}
var _34e=_34b.data.stencilId;
var _34f=document.getElementById(_34e);
if($(_34f).parents(".transition-wrapper:first").length){
return;
}
var _350=$(_34f).closest(".mobile-interaction-potential-trigger");
var _351=_350.attr("id");
var _352=$(_350).position();
var _353=true;
if($(_34f).hasClass("layer")){
_353=false;
}
var _354=this.triggerGroups[_351];
if(!_354){
_354=$("<div class=\"mobile-interactions-trigger-group-"+_351+" mobile-interactions-trigger-group\" data-trigger-id=\""+_351+"\"></div>");
this.triggerGroups[_351]=_354;
$(_350).mouseenter(function(e){
this.displayInteractions(_354);
return false;
}.bind(this)).mouseleave(function(e){
this.hideAllInteractions();
if(_353){
var id=$(_34f).closest(".repository").attr("id");
this.displayInteractions($(".mobile-interactions-trigger-group-"+id));
}
return false;
}.bind(this));
_354.css({left:_352.left/rabbit.facade.getScaleFactor(),top:_352.top/rabbit.facade.getScaleFactor()-this.groupTopOffset});
this.container.append(_354);
$(_354).mouseenter(function(e){
this.displayInteractions(_354);
return false;
}.bind(this)).mouseleave(function(e){
this.hideAllInteractions();
...
var _355=$("<div class=\"active interaction-trigger interaction-trigger-"+_34b.data.uniqueId+" interaction-trigger-"+_34c.type+"\" title=\""+t("interaction-trigger-"+_34b.data.action.type+"-tooltip")+"\">"+t("trigger-label-"+_34c.type)+"</div>");
if(!_353){
_355.addClass("interaction-trigger-layer-"+_34e.replace("-layer",""));
}
_355.click(function(){
rabbit.facade.raiseInteraction(_34b);
this.hideAllInteractions();
}.bind(this));
_354.append(_355);
this.interactions[_34b.data.uniqueId]=_34b;
},hideAllInteractions:function(){
$(".mobile-interactions-trigger-group").removeClass("visible");
},displayInteractions:function(_356){
$(".mobile-interactions-trigger-group").removeClass("visible");
this.updateTriggerGroupPosition(_356);
$(_356).addClass("visible");
...
$(".mobile-interactions-trigger-group").each(function(_357,_358){
this.updateTriggerGroupPosition($(_358));
}.bind(this));
}
...
},updateTriggerGroupPosition:function(_359){
var _35a=$("#"+_359.data("trigger-id"));
if(_35a.length){
var _35b=_35a.position();
$(_359).css({left:_35b.left/rabbit.facade.getScaleFactor(),top:_35b.top/rabbit.facade.getScaleFactor()-this.groupTopOffset});
}
},updateAllTriggerGroupPosition:function(){
for(var _35c in this.triggerGroups){
this.updateTriggerGroupPosition(this.triggerGroups[_35c]);
}
}};
...
},pageLoaded:function(page,_35d){
this.changeLinks(page.data.id);
},changeLinks:function(_35e){
var _35f=rabbit.communication.manager.buildEditUrl(rabbit.result.manager.currentPageNr);
var _360=rabbit.facade.getUrlPattern().replace("__page__",_35e);
var _361=_360.replace(this.mode,"sketched").replace("?fontFamily=arial","");
var _362=_360.replace(this.mode,"sketchedArial");
var _363=_360.replace(this.mode,"plain").replace("?fontFamily=arial","");
this.toolbar.find(".edit-btn").attr("href",_35f);
this.toolbar.find(".sketched-btn").attr("href",_361);
this.toolbar.find(".sketched-arial-btn").attr("href",_362);
this.toolbar.find(".plain-btn").attr("href",_363);
}};
...
rabbit.facade.registerReaction("showOverlay",{init:function(_364,_365){
this.prepareOverlay(_364.data.uniqueId,_365.target);
}.bind(this),callback:function(_366,_367,_368){
this.showOverlay(_367.data.uniqueId,_368.target);
}.bind(this)});
rabbit.facade.registerReaction("hideOverlay",{callback:function(_369,_36a,_36b){
this.hideOverlay();
}.bind(this)});
},prepareOverlay:function(_36c,_36d){
var _36e=$("<div></div>");
var id="overlay-"+_36c;
var page=rabbit.data.pageStore.objects[_36d];
var url,ajax;
if(page){
_36e.addClass("overlay").addClass("repository").attr("id",id).attr("data-original-layer-id",_36d).attr("data-page-id",_36d).attr("data-apply-scale-factor","").appendTo("body").css({width:page.data.width+"px",height:page.data.height+"px"}).data("has-rectangle",false);
this.loadRectangle(page.data.width,page.data.height);
rabbit.ui.manager.createWrappers(id,_36d,true);
rabbit.facade.loadLayer(_36d);
}
},loadRectangle:function(_36f,_370){
if(this.hasRectangle(_36f,_370)){
return;
}
if(rabbit.result.manager.isExport){
var _371=(rabbit.browser==="ie")?"-ie":"";
url=rabbit.communication.manager.getUrl("rectangleExport",{height:_370,width:_36f,mode:rabbit.util.getMode()});
...
ajax=rabbit.communication.manager.get(url,"html",{height:_370,width:_36f});
ajax.success(function(html){
var _372=$(html).children().first();
this.setRectangle(_36f,_370,_372);
}.bind(this));
}
},setRectangle:function(_373,_374,html){
this.rectangles[_373+"x"+_374]=html;
},getRectangle:function(_375,_376){
return $(this.rectangles[_375+"x"+_376]).clone();
},hasRectangle:function(_377,_378){
return typeof this.rectangles[_377+"x"+_378]!=="undefined";
},showOverlayBackground:function(){
$(".overlay-background").show();
},hideOverlayBackground:function(){
$(".overlay-background").hide();
},showOverlay:function(_379,_37a){
var id="overlay-"+_379;
var page=rabbit.data.pageStore.objects[_37a];
var _37b=rabbit.facade.getCurrentPage();
var _37c=$("#"+id);
if(page){
var _37d=page.data.width;
var _37e=page.data.height;
if(!_37c.data("has-rectangle")){
_37c.append(this.getRectangle(_37d,_37e));
_37c.data("has-rectangle",true);
}
var _37f=$("#repository").offset();
var _380=$(document).height()>$(window).height();
var top,left;
if(_380){
top=(window.innerHeight-parseInt(_37e))/2;
left=(rabbit.facade.getMode()==="plain")?(_37b.data.width-parseInt(_37d))/2:(window.innerWidth-parseInt(_37d))/2;
}else{
top=_37f.top+(_37b.data.height*rabbit.facade.getScaleFactor()-parseInt(_37e))/2;
left=_37f.left+(_37b.data.width*rabbit.facade.getScaleFactor()-parseInt(_37d))/2;
}
_37c.show().css({top:top,left:left,transform:"scale("+rabbit.facade.getScaleFactor()+", "+rabbit.facade.getScaleFactor()+")"});
rabbit.ui.manager.showPage($("#"+id),_37a);
this.showOverlayBackground();
this.shownOverlays.push(_37c);
}else{
}
},hideOverlay:function(){
var _381=this.shownOverlays.pop();
_381.hide();
this.hideOverlayBackground();
}};
rabbit.facade.registerPlugin(rabbit.plugins.overlay);
rabbit.plugins.scrollTo=function(){
var _382=rabbit.facade;
return {init:function(){
_382.registerReaction("scrollTo",{callback:function(_383,_384,_385){
this.scrollTo(_385.position,_385.duration);
}.bind(this)});
},scrollTo:function(_386,_387){
var _388=$("html, body");
var _389=$(".border-wrapper");
if(rabbit.facade.isFrameDisplayed&&_389[0].scrollHeight>_389.height()){
_388=_389;
}
if(_386==="bottom"){
_388.animate({scrollTop:_388[0].scrollHeight},parseInt(_387));
}else{
_388.animate({scrollTop:0},parseInt(_387));
}
}};
}();
rabbit.facade.registerPlugin(rabbit.plugins.scrollTo);
rabbit.plugins.startDialer={shownOverlays:[],rectangles:{},init:function(){
rabbit.facade.registerReaction("startDialer",{callback:function(_38a,_38b,_38c){
this.startDialer(_38c.phoneNumber);
}.bind(this)});
},startDialer:function(_38d){
window.location.href="tel:"+_38d;
}};
...
var _38e=e.targetTouches[i];
var _38f=this.makeCircle(_38e.pageX-this.offset.left,_38e.pageY-this.offset.top);
this.touchViewer[0].appendChild(_38f);
}
e.preventDefault();
},touchEndListener:function(){
setTimeout(function(){
var _390=this.touchViewer.find("div");
_390.each(function(){
...
var _391=this.touchViewer.find("div");
_391.each(function(){
...
var _392=document.getElementsByClassName("touch");
for(var i=0;i<_392.length;i++){
_392[i].setAttribute("class",_392[i].getAttribute("class")+" touch-success");
}
}};
}();
rabbit.facade.registerPlugin(rabbit.plugins.gestureHighlight);
rabbit.plugins.hold={init:function(){
rabbit.facade.registerAction("hold",{makeableOnDesktop:true,render:function(_393){
return t("interaction.action.hold.userDescription");
},defineEvent:function(_394){
var _395=Hammer(document.getElementById(_394.data.stencilId),{hold_timeout:_394.data.action.timeout});
_395.on("hold",function(e){
rabbit.interaction.manager.raiseInteraction(_394,{});
});
}});
}};
rabbit.facade.registerPlugin(rabbit.plugins.hold);
rabbit.plugins.valueChanged={listenedGroups:{},init:function(){
rabbit.facade.registerAction("booleanValueChanged",{makeableOnDesktop:true,render:function(_396){
return t("interaction.action.booleanValueChanged.userDescription");
},defineEvent:function(_397){
var _398=_397.data.stencilId;
var _399=$("#"+_398);
if(_399.hasClass("radiobutton")){
var _39a=_399.find("input:first").attr("name");
if(!_.has(rabbit.plugins.valueChanged.listenedGroups,_39a)){
rabbit.plugins.valueChanged.listenedGroups[_39a]=[];
$("input[name=\""+_39a+"\"]").change(function(e){
var _39b=$(e.target).val();
var _39c=$(e.target).data("old-selected-radiobutton-id");
for(var i=0;i<rabbit.plugins.valueChanged.listenedGroups[_39a].length;i++){
var _39d=rabbit.plugins.valueChanged.listenedGroups[_39a][i];
var _39e=_39d.data.stencilId;
var _39f=_39d.data.action.selected;
if(_39b===_39e&&_39f==="yes"||_39c===_39e&&_39f==="no"||(_39b===_39e||_39c===_39e)&&_39f==="toggle"){
rabbit.interaction.manager.raiseInteraction(_39d,rabbit.interaction.manager.serializeEvent(e));
}
}
$("input[name=\""+_39a+"\"]").data("old-selected-radiobutton-id",_39b);
});
}
rabbit.plugins.valueChanged.listenedGroups[_39a].push(_397);
}else{
if(_399.hasClass("checkbox")){
$("#"+_397.data.stencilId+" input:first").change(function(e){
if($(e.target).is(":checked")===(_397.data.action.selected==="yes")||_397.data.action.selected==="toggle"){
rabbit.interaction.manager.raiseInteraction(_397,rabbit.interaction.manager.serializeEvent(e));
}
});
}else{
if(_399.hasClass("iphoneSwitch")){
var _3a0=function(id){
if(_397.data.stencilId===id){
rabbit.interaction.manager.raiseInteraction(_397);
}
};
if(_397.data.action.selected==="yes"||_397.data.action.selected==="toggle"){
rabbit.facade.registerOnEvent(rabbit.events.switchOffSwitch,_3a0,this);
}
if(_397.data.action.selected==="no"||_397.data.action.selected==="toggle"){
rabbit.facade.registerOnEvent(rabbit.events.switchOnSwitch,_3a0,this);
}
}
}
}
}});
rabbit.facade.registerAction("stringValueChanged",{makeableOnDesktop:true,render:function(_3a1){
return t("interaction.action.stringValueChanged.userDescription");
},defineEvent:function(_3a2){
$("#"+_3a2.data.stencilId).change(function(e){
if(e.target.value===_3a2.data.action.value){
...
rabbit.facade.registerOnEvent(rabbit.events.newInteractionRegistered,function(_3a3){
var _3a4=document.getElementById(_3a3.getData().stencilId);
var _3a5=_3a4.hasAttribute("data-stencil-id");
var _3a6=_3a4.hasAttribute("data-layer-id");
var id=_3a3.getData().stencilId;
if(!_3a5&&!_3a6&&!this.detailFootnotes[id]){
this.detailFootnotes[id]=_.size(this.detailFootnotes)+1;
}
},this);
rabbit.facade.registerOnEvent(rabbit.events.pageReady,function(){
$(".has-footnote").each(function(_3a7,_3a8){
var _3a9=_3a8.getAttribute("data-stencil-id");
if(!_3a9){
_3a9=_3a8.getAttribute("data-layer-id");
}
if(!this.detailFootnotes[_3a9]){
this.detailFootnotes[_3a9]=_.size(this.detailFootnotes)+1;
}
}.bind(this));
},this);
...
},showFootnote:function(_3aa,x,y,type,_3ab,_3ac,_3ad,_3ae,text,_3af){
var _3b0=_3aa.offset();
var _3b1=x;
var _3b2=y;
if(!_3ad){
_3b1-=_3b0.left;
...
if(!_3ac){
if(type=="detail"){
_3b3=(this.counterDetailFootnotes++)+1;
}else{
if(type=="discussion"){
_3b3=this.getDiscussionLetters(this.counterDiscussionFootnotes++);
}
}
_3b4=$("<div class=\"footnote-marker footnote-marker-"+type+"\">"+_3b3+"</div>").css({left:_3b1,top:_3b2});
_3aa.append(_3b4);
}
this.placedMarkers.push({stencilOrLayerId:_3ab,stencilUniqueId:_3aa.attr("id"),type:type,index:_3b3,x:x,y:y,outsideOfPage:_3ac,inStencilInteraction:_3ad,target:_3ae,text:text,footnoteId:_3af,footnoteElement:_3b4});
},getShownFootnoteIndexes:function(type){
var _3b5={};
for(var i=0;i<this.placedMarkers.length;i++){
var _3b6=this.placedMarkers[i];
if(!type||_3b6.type==type){
_3b5[_3b6.index]={index:_3b6.index,stencilUniqueId:_3b6.stencilUniqueId,outsideOfPage:_3b6.outsideOfPage,inStencilInteraction:_3b6.inStencilInteraction,stencilOrLayerId:_3b6.stencilOrLayerId,target:_3b6.target,text:_3b6.text,footnoteId:_3b6.footnoteId};
}
}
return _3b5;
...
},showDetailFootnotes:function(_3b7){
for(var _3b8 in this.detailFootnotes){
var _3b9=false;
var _3ba=$("[data-stencil-id=\""+_3b8+"\"], .wrapper[data-layer-id=\""+_3b8+"\"][data-layer-id=\""+_3b7+"\"]");
var _3bb=null,text=null;
if(!_3ba.length){
_3ba=$("#"+_3b8);
_3b9=true;
_3bb=_3ba.attr("data-href");
text=_.str.clean(_3ba.text());
text=_.str.truncate(text,20);
_3b8=null;
}
for(var i=0;i<_3ba.length;i++){
var _3bc=$(_3ba.get(i));
if(!_3bc.closest(".wrapper[data-layer-id=\""+_3b7+"\"]").length){
continue;
}
var _3bd=_3bc.offset();
var _3be=_3bc.width();
if(_3b9){
_3be=_3bc.width()/2;
}
var x=_3bd.left+_3be;
var y=_3bd.top-20;
var _3bf=this.findPosition(x,y,"x",1);
this.placedMarkersInPageCoordinateSystem.push({x:_3bf.x,y:_3bf.y});
if(_3b9){
var _3c0=_3bc.position();
_3bf.x=_3c0.left+_3be+(x-_3bf.x);
_3bf.y=_3c0.top-20+(y-_3bf.y);
}
this.showFootnote(_3bc,_3bf.x,_3bf.y,"detail",_3b8,_3bf.outsideOfPage,_3b9,_3bb,text);
}
}
this.sortFootenotes();
},sortFootenotes:function(){
this.placedMarkers=_.sortBy(this.placedMarkers,function(_3c1){
return ($(_3c1.footnoteElement).offset())?$(_3c1.footnoteElement).offset().left:100000;
});
for(var i=0;i<this.placedMarkers.length;i++){
var _3c2=this.placedMarkers[i].footnoteElement;
$(_3c2).text(i+1);
this.placedMarkers[i].index=i+1;
}
},getShownDetailFootnotes:function(){
return this.getShownFootnoteIndexes("detail");
},getDiscussionLetters:function(_3c3){
var v="abcdefghijklmnopqrstuvwxyz".split("");
var _3c4="";
var nr=Math.floor(_3c3/26);
var mod=_3c3%26;
...
_3c4+=v[mod];
return _3c4;
},showDiscussionFootnotes:function(_3c5){
var _3c6="abcdefghijklmopqrestuvwxyz".split("");
var _3c7=$("#repository").offset();
var _3c8=this.discussionFootnotes[_3c5];
if(_.isArray(_3c8)){
for(var i=0;i<_3c8.length;i++){
var _3c9=_3c8[i];
var _3ca=_3c9.referenceId;
var _3cb=$(".wrapper-"+_3c5+">.layer [data-stencil-id=\""+_3ca+"\"]");
if(_3cb.length===0){
_3cb=$("[data-page-id=\"page0001\"]");
}
for(var j=0;j<_3cb.length;j++){
var _3cc=$(_3cb.get(j));
var _3cd=_3cc.offset();
var x=_3cd.left+_3c9.x;
var y=_3cd.top+_3c9.y;
var _3ce=this.findPosition(x,y,"x",1);
this.placedMarkersInPageCoordinateSystem.push({x:_3ce.x,y:_3ce.y});
this.showFootnote(_3cc,_3ce.x,_3ce.y,"discussion",_3c9.id,_3ce.outsideOfPage,null,null,null,_3c9.id);
}
}
}
},getShownDiscussionFootnotes:function(){
return this.getShownFootnoteIndexes("discussion");
},findPosition:function(x,y,_3cf,deep){
deep=deep||1;
...
return this._findPosition(x,y,_3cf,deep);
}
},_findPosition:function(x,y,_3d0,deep){
var _3d1={x:x,y:y,outsideOfPage:false};
var _3d2=false;
var _3d3=null;
var _3d4=null;
var _3d5=null;
...
var _3d7=true;
var _3d8=true;
var _3d9=this.placedMarkersInPageCoordinateSystem[i];
var _3da=x-_3d9.x;
if(Math.abs(_3da)<this.markerSize){
_3d7=false;
if(_3da>0){
_3d3=Math.abs(_3da);
}else{
...
var _3db=y-_3d9.y;
if(Math.abs(_3db)<this.markerSize){
_3d8=false;
if(_3db>0){
_3d5=Math.abs(_3db);
}else{
...
_3d1.x=Math.min(_3d1.x,$("#repository").width()-2*this.markerSize);
_3d1.y=Math.min(_3d1.y,$("#repository").height()-2*this.markerSize);
if(_3d2&&deep<100){
if(_3d0=="x"){
var _3dc=true;
if(_3d4===null&&x<xMax||_3d3!==null&&_3d4<_3d3||x<0){
_3dc=false;
}
if(_3dc){
_3d1.x=x-this.markerSize;
}else{
_3d1.x=x+this.markerSize;
}
}
if(_3d0=="y"){
var _3dd=true;
if(_3d6===null&&y<yMax||_3d5!==null&&_3d6<_3d5||y<0){
_3dd=false;
}
if(_3dd){
_3d1.y=y-this.markerSize;
}else{
_3d1.y=y+this.markerSize;
}
}
return this.findPosition(_3d1.x,_3d1.y,(_3d0==="x")?"y":"x",++deep);
}else{
return _3d1;
}
}};
...
},highlightStencil:function(_3de){
var _3df=$("<div class=\"stencil-highlighter-highlighted\"></div>");
_3de.append(_3df);
},hideHighlightLayer:function(_3e0){
$(".layer[data-layer-id=\""+_3e0+"\"] .stencil .stencil-highlighter-highlighted").remove();
},showHighlightLayer:function(_3e1){
this.hideHighlightLayer(_3e1);
var _3e2=$(".layer[data-layer-id=\""+_3e1+"\"] .stencil");
for(var i=0;i<_3e2.length;i++){
this.highlightStencil($(_3e2.get(i)));
}
},deopacify:function(){
$(".stencil-highlighter-opacifyied").removeClass("stencil-highlighter-opacifyied");
},opacifyExceptLayer:function(_3e3){
this.deopacify();
var _3e4=$(".stencil");
for(var i=0;i<_3e4.length;i++){
var _3e5=$(_3e4.get(i));
if(!_3e5.closest(".layer[data-layer-id=\""+_3e3+"\"]").length){
_3e5.addClass("stencil-highlighter-opacifyied");
}
}
}};
...
var _3e6=document.querySelectorAll(".layer");
for(var i=0;i<_3e6.length;i++){
this.activateLinksForLayer(_3e6[i]);
}
},this);
rabbit.facade.registerOnEvent("layerStoreInserted",this.activateLinksForLayer,this);
},activateLinksForLayer:function(_3e7){
var _3e8=_3e7.querySelectorAll(".default-text2-container a[href]");
...
var id=link.id;
var _3e9=link.getAttribute("href");
rabbit.interaction.manager.registerInteraction(id,"tinymce-interaction-"+id,{"button":"left","id":"tinymce-action-"+id,"numberOfFinger":"1","type":"click"},[{"delay":"0","id":"tinymce-reaction-"+id,"options":"reloadOnly","target":_3e9,"transition":"none","type":"showPage"}]);
link.className=link.className+" pidoco-clickable-element";
link.setAttribute("data-href",_3e9);
...
$.ajax({url:rabbit.common.baseUrl+rabbit.util.appendVersionQuery("common/stencil-icons.svg"),method:"GET",success:function(data,_3ea,_3eb){
...
$.ajax({url:rabbit.common.baseUrl+rabbit.util.appendVersionQuery("common/frames.svg"),method:"GET",success:function(data,_3ec,_3ed){
var body=document.body;
body.insertBefore(data.firstChild,body.firstChild);
...
_3ee=rabbit.parameters.fitScreen;
}
}
var _3ef=false;
if(rabbit.parameters.isApi){
...
_3ef=!rabbit.parameters.showFrame;
}
}
rabbit.facade.registerUserPref("simulationFitScreen",_3ee);
rabbit.facade.registerUserPref("hidePageFrame",_3ef);
...
this.updateFrame(this.lastPage,this.lastRepository);
},frameReset:function(page,_3f2){
this.simulationScaled.css({transform:"scale(1)"});
this.borderWrapper[0].style.removeProperty("width");
this.borderWrapper[0].style.removeProperty("height");
},pageReady:function(page,_3f3){
this.lastPage=page;
this.lastRepository=_3f3;
this.pageLoaded(page,_3f3);
if(rabbit.facade.getUserPref("hidePageFrame")){
this.hideFrame();
}
setTimeout(function(){
...
},pageLoaded:function(page,_3f4,_3f5){
this.lastPage=page;
this.lastRepository=_3f4;
var _3f6=page.getData().frame;
var _3f7=page.getData().frameOrientation;
var _3f8=!rabbit.facade.getUserPref("hidePageFrame");
if(!rabbit.common.frames[_3f6]||!rabbit.common.frames[_3f6][_3f7]){
this.hideFrame(true);
}else{
if(_3f8){
this.showFrame(true);
...
},updateFrame:function(page,_3f9,_3fa){
if(!this.framesLoaded){
return;
}
var _3fb=true;
if(!_3fa){
this.frameReset(page,_3f9);
_3fb=false;
}
var _3fc=page.getData().frame;
var _3fd=page.getData().frameOrientation;
var _3fe=rabbit.common.frames.none;
var _3ff=page.getData().width;
var _400=page.getData().height;
var _401=0;
var _402=0;
if(_3fc=="custom"){
_3fd="custom";
...
if(!rabbit.common.frames[_3fc]||!rabbit.common.frames[_3fc][_3fd]){
rabbit.plugins.toolbar.hideFrameButtons();
this.hideFrame(true);
return;
}else{
}
var _403=_3fc=="custom"&&(_3ff<rabbit.common.frames.custom.sideMinLength||_400<rabbit.common.frames.custom.sideMinLength);
if(!this.pageTooSmallForCustom&&_403){
...
var _404=!rabbit.facade.getUserPref("hidePageFrame");
if(_404){
_3fe=rabbit.common.frames[_3fc];
if(_3fc!=="custom"){
_3ff=_3fe[_3fd].innerWidth;
_400=_3fe[_3fd].innerHeight;
}
_401=_3fe[_3fd].frameBorderLeft;
_402=_3fe[_3fd].frameBorderTop;
rabbit.facade.isFrameDisplayed=true;
}else{
rabbit.facade.isFrameDisplayed=false;
}
this.frame.firstElementChild.setAttribute("xlink:href","#"+_3fc+"-"+_3fd);
this.simulationScaled.css({transform:"scale(1)"});
var _405=1;
if(rabbit.facade.getUserPref("simulationFitScreen")&&!_3fb&&_404){
var _406=30;
var _407=_3fe[_3fd].frameBorderTop*2+_400+10;
_405=Math.min(1,(window.innerHeight-$(".toolbar-wrapper").height()-_406)/_407);
}
rabbit.facade.setScaleFactor(_405);
var _408=(rabbit.facade.isApi()||$("body").hasClass("plain"))?0:10;
this.simulationContainer.css({width:(_401*2+_3ff+_408)*_405,height:(_402*2+_400+_408)*_405});
var _409=_3ff;
var _40a=_400;
this.borderWrapper.css("overflow","hidden");
if(!rabbit.facade.getUserPref("hidePageFrame")&&this.borderWrapper[0].scrollWidth>_409){
_40a+=rabbit.util.getScrollbarWidth();
}
if(!rabbit.facade.getUserPref("hidePageFrame")&&this.borderWrapper[0].scrollHeight>_40a){
_409+=rabbit.util.getScrollbarWidth();
}
this.borderWrapper.css({left:_401,top:_402,width:_409,height:_40a,overflow:"auto"});
this.simulationScaled.css({transform:"scale("+_405+")"});
$("[data-apply-scale-factor]").css({transform:"scale("+_405+")"});
if(_3fc=="custom"){
rabbit.common.frames.adjusteCustomFrame(_3ff,_400);
}
rabbit.facade.raiseEvent(rabbit.events.frameChanged,_3fc,_3fd);
}};
...
var _40b=rabbit.facade.getUserPref("simulationAlignment");
if(_40b&&rabbit.plugins.prototypeAlignment[_40b]&&!rabbit.facade.isPhantomJS()){
rabbit.plugins.prototypeAlignment[_40b]();
}
},left:function(){
...
return {init:function init(){
},setupAutocomplete:function setupAutocomplete(id,_40c){
_40c=_40c.split("|c");
var oDS=new YAHOO.util.LocalDataSource(_40c);
...
},layerStoreInsertedListener:function(_40d){
$(_40d).find(".stencil.textinput").click(function(){
rabbit.facade.markHighlightTouchesAsSuccessful();
});
...
rabbit.facade.registerOnEvent(rabbit.events.layerStoreInserted,this.layerStoreInsertedListener,this);
rabbit.facade.registerOnEvent(rabbit.events.pageReady,this.pageReadyListener,this);
},layerStoreInsertedListener:function(_40e){
$(_40e).find(".stencil.combobox").click(function(){
rabbit.facade.markHighlightTouchesAsSuccessful();
});
},pageReadyListener:function(){
...
var _40f=600;
var _410=".accordion-header";
var _411=".accordion-content";
var _412="accordion-active";
var _413=30;
var _414=function(_415){
var _416=$(_415).parents().children(_410);
var _417=_416.index(_415);
return _417;
};
var _418=function(_419){
return $(_419).closest(".stencil").attr("id");
};
var _41a=function(_41b){
return $("#"+_41b).find(_410).length;
};
var _41c=function(_41d,_41e,_41f){
var _420=$("#"+_41d+">div>"+_410).length;
$("#"+_41d).find(_411+">div, "+_411+">iframe").css("position","relative").css("left","0px").css("top","0px").css("width",_41e+"px").css("height",(_41f-_420*_413-2)+"px");
};
return {_accordions:{},init:function init(){
},setupAccordion:function(id,_421,_422,_423){
var _424=_41a(id);
if(_423<1){
_423=1;
}
...
_423--;
$("#"+id).find(_410).click({"accordionObject":this},this.raiseClickCallback);
_41c(id,_421,_422);
this.showTab(id,_423,false);
},showTab:function(id,_425,_426){
this._accordions[id]=_425;
if(_426){
$("#"+id).find(_411).slideUp(_40f);
}else{
$("#"+id).find(_411).hide();
}
var _427=$("#"+id).find(_410).removeClass(_412)[_425];
$(_427).addClass(_412).next().slideDown(_40f,function onCompleteCallback(){
...
},clickCallback:function(that,_428){
var _429=_414(_428);
var _42a=_418(_428);
if(that._accordions[_42a]===_429){
return;
}
rabbit.facade.markHighlightTouchesAsSuccessful();
that.showTab(_42a,_429,true);
}};
}();
...
var _42b=rabbit.facade;
return {init:function init(){
_42b.registerOnEvent(rabbit.events.buttonMouseOver,this.onMouseOver,this);
_42b.registerOnEvent(rabbit.events.buttonMouseOut,this.onMouseOut,this);
...
var _42c=rabbit.facade;
return {init:function init(){
rabbit.facade.registerOnEvent(rabbit.events.checkBoxClicked,this.onClick,this);
},onClick:function onClick(_42d,_42e){
rabbit.facade.markHighlightTouchesAsSuccessful();
console.log("Click to checkbox "+_42d);
var _42f=document.getElementById(_42d);
if(_42f==null){
return true;
}
var _430=document.getElementById(_42e);
if(_430==null){
return true;
}
if(!_42f.checked){
_430.setAttribute("visibility","hidden");
}else{
_430.setAttribute("visibility","inherit");
}
return true;
}};
}();
...
var _431=rabbit.facade;
var _432=[];
var _433=false;
var _434=null;
var _435=function(id){
for(var i=0;i<_432.length;i++){
var _436=_432[i];
if(_436.calendarId==id){
return _436;
}
}
return null;
};
var _437=function(id,year,_438){
var _439=_435(id);
_439.calendar.setYear(year);
_439.calendar.setMonth(_438);
_439.calendar.render();
};
var _43a=function _hideCalendar(id,_43b,_43c){
if(_43b){
document.getElementById(id+"_input").value=_43b;
}
var _43d=_435(id);
_43d.calendarVisible=false;
var svg=document.getElementById(_43d.calendarId+"_open_calendar");
if(svg){
...
_43d.overlay.hide();
_433=false;
$("html").unbind("click",_434);
};
var _43e=function _showCalendar(id,_43f){
var _440=_435(id);
_440.calendarVisible=true;
_440.calendar.show();
_440.overlay.show();
_433=true;
var svg=document.getElementById(_440.calendarId+"_open_calendar");
if(svg){
...
$("html").bind("click",_434);
};
var _441=function _441(_442){
for(var i=0;i<_442.childNodes.length;i++){
var _443=_442.childNodes[i];
if(_443.nodeType!=1){
continue;
}
if(_443.getAttribute("id")==undefined){
_443.setAttribute("id",_442.getAttribute("id")+"_"+i);
}
arguments.callee(_443);
}
};
var _444=function _444(evt){
if(!evt){
return;
}
if(!_431.vml){
...
return {init:function init(){
_431.registerOnEvent(rabbit.events.click,this.hideDatePickerOnClick,this);
rabbit.facade.registerOnEvent(rabbit.events.showDatepicker,_43e,this);
rabbit.facade.registerOnEvent(rabbit.events.hideDatepicker,_43a,this);
rabbit.facade.registerOnEvent(rabbit.events.changeDatepickerPage,_437,this);
},calendarOpen:function(id){
return _433;
}(),setupDatepicker:function setupDatepicker(id){
try{
var _445=new YAHOO.widget.Overlay(id+"_ov",{zIndex:9990,width:"200px",height:"200px",context:[id+"_input","tl","bl"]});
_445.render();
...
_446.overlay=_445;
_446["calendarId"]=id;
_446["calendarVisible"]=false;
_432.push(_446);
cal.selectEvent.subscribe(rabbit.util.bind(function(evt,d){
var _447=this.formatIsoDate(d[0][0][0],d[0][0][1],d[0][0][2]);
rabbit.facade.raiseEvent(rabbit.events.hideDatepicker,_446.calendarId,_447,rabbit.util.userRole,"displayMouseClick");
},this),cal,true);
cal.render();
cal.hide();
_445.hide();
var _448=id+"_cal";
_441(document.getElementById(id+"_cal"));
cal.changePageEvent.subscribe(rabbit.util.bind(function(evt,d){
var date=cal.cfg.getProperty("pagedate");
var year=date.getUTCFullYear();
var _449=date.getMonth();
rabbit.facade.raiseEvent(rabbit.events.changeDatepickerPage,_446.calendarId,year,_449,rabbit.util.userRole,"displayMouseClick");
_441(document.getElementById(_448));
},this),cal,true);
YAHOO.util.Event.addListener(id+"_button","click",rabbit.util.bind(this.toggleCalendarCallback,this),_446);
YAHOO.util.Event.addListener(id+"_input","focus",rabbit.util.bind(this.toggleCalendarCallback,this),_446);
YAHOO.util.Event.addListener(id+"_ov","click",_444);
}
catch(e){
...
for(var i=0;i<_432.length;i++){
var _44a=_432[i];
if(_44a.calendarVisible){
rabbit.facade.raiseEvent(rabbit.events.hideDatepicker,_44a.calendarId,null,rabbit.util.userRole,"displayMouseClick");
}
}
}
},toggleCalendarCallback:function toggleCalendarCallback(evt,_44b){
if(!_44b.calendarVisible){
rabbit.facade.raiseEvent(rabbit.events.showDatepicker,_44b.calendarId,rabbit.util.userRole,"displayMouseClick");
this.calendarOpen=true;
}else{
rabbit.facade.raiseEvent(rabbit.events.hideDatepicker,_44b.calendarId,null,rabbit.util.userRole,"displayMouseClick");
...
var _44f=function(_450,_451){
var menu=_44d(_450);
if(menu){
for(var i=0;i<_451.length;i++){
var _452=menu.getSubmenus();
for(var j=0;j<_452.length;j++){
if(_452[j].id==_451[i]){
menu=_452[j];
}
}
...
var _453=function(_454,_455,_456){
if(_456&&_456!=rabbit.util.userRole){
var _457=_44f(_454,_455);
if(_457){
_457.show();
}
}
};
var _458=function(_459,_45a,_45b){
if(_45b&&_45b!=rabbit.util.userRole){
var _45c=_44f(_459,_45a);
if(_45c){
_45c.hide();
}
}
};
var _45d=function(obj){
var menu=obj;
var _45e=[];
...
$(_462.element).css({left:_462.parent.position().left,top:top});
};
var _463=function(_464){
var _465=-4;
var _466=$(_464.parent.element);
$(_464.element).css({left:_466.width()+1/rabbit.facade.getScaleFactor(),top:_466.position().top/rabbit.facade.getScaleFactor()+_465});
};
var _467=function(){
var _468=$(this.element.parentNode).hasClass("yuimenubaritem");
if(_468){
_461(this);
}else{
_463(this);
...
var _469=_45d(this);
rabbit.facade.raiseEvent(rabbit.events.subMenuShow,_469[0],_469[1],rabbit.util.userRole);
};
var _46a=function(){
var _46b=_45d(this);
rabbit.facade.raiseEvent(rabbit.events.subMenuHide,_46b[0],_46b[1],rabbit.util.userRole);
};
return {init:function(){
rabbit.facade.registerOnEvent(rabbit.events.subMenuShow,_453,this);
rabbit.facade.registerOnEvent(rabbit.events.subMenuHide,_458,this);
},convertMethodIntoFunction:function(_46c){
for(var i=0;i<_46c.length;i++){
var _46d=_46c[i].onclick;
if(_46d&&_46d.fn!=="undefined"){
_46d.fn=eval(_46d.fn);
}
if(_46c[i].submenu){
var _46e=_46c[i].submenu.itemdata;
this.convertMethodIntoFunction(_46e);
}
}
},setupMenu:function setupMenu(id,_46f,_470){
try{
_46f=_46f.replace(/:rabbit.result.manager.menuClick,/g,":\"rabbit.result.manager.menuClick\",");
_46f=JSON.parse(_46f);
this.convertMethodIntoFunction(_46f);
var _471;
if(_470=="vertical"){
_471=new YAHOO.widget.Menu(id+"-bar",{itemdata:_46f,visible:true,position:"static",hidedelay:750,lazyload:true});
}else{
_471=new YAHOO.widget.MenuBar(id+"-bar",{lazyload:true,autosubmenudisplay:true,showdelay:10,itemdata:_46f});
}
_471.render(id+"-menu-container");
_471.show();
_471.domId=id;
_44c.push(_471);
_471.subscribe("show",_467);
_471.subscribe("hide",_46a);
}
catch(e){
console.error(e);
}
...
var _472=rabbit.facade;
return {init:function init(){
_472.registerOnEvent(rabbit.events.radioButtonClicked,this.onClick,this);
...
if(_474[i].type==="radio"){
_473.push(_474[i]);
}
}
return _473;
},onClick:function onClick(_475,_476){
rabbit.facade.markHighlightTouchesAsSuccessful();
console.log("Click to radioButton "+_475);
var _477=this.getAllRadioButtons();
for(var i=0;i<_477.length;i++){
var _478=_477[i];
var _479=_478.getAttribute("id")+"_svgChecked";
var _47a=document.getElementById(_479);
if(_47a!=null){
if(!_478.checked){
if(rabbit.facade.vml){
_47a.style.setAttribute("display","none");
}else{
_47a.setAttribute("visibility","hidden");
}
}else{
if(rabbit.facade.vml){
_47a.style.removeAttribute("display");
}else{
_47a.setAttribute("visibility","inherit");
}
}
}
}
...
var _47b={};
var _47c=function(_47d,_47e,_47f){
var _480=_47b[_47d];
if(!_480){
return;
}
if(_47f!=null&&_47f!=rabbit.util.userRole){
console.log("_sliderChangedCallback "+_47e);
_480.setValue(_47e);
}
};
return {init:function init(){
rabbit.facade.registerOnEvent(rabbit.events.sliderChangedEvent,_47c,this);
},setupSlider:function(id,_481,_482,_483,_484){
try{
_481=parseInt(_481);
_483=parseInt(_483);
if(_484){
_484=parseInt(_484)*2;
}else{
_484=0;
}
var _485=(_483-(_483)/21)/10;
var _486=_485*_481;
var _487=_483-_486;
var _488=null;
if(_482=="vertical"){
_488=YAHOO.widget.Slider.getVertSlider(id,id+"_thumb_vert",_487,_486,_485);
}else{
_488=YAHOO.widget.Slider.getHorizSlider(id,id+"_thumb_horiz",_487,_486,_485);
}
_47b[id]=_488;
_488.animate=false;
_488.subscribe("change",function(){
var _489=Math.round(this.getValue()+_484);
rabbit.facade.raiseEvent(rabbit.events.sliderChangedEvent,id,_489,rabbit.util.userRole);
});
}
catch(e){
console.error(e);
...
var _48b=function _48b(_48c,_48d){
var node=document.getElementById(_48c);
if(node){
node.style.setProperty("fill",_48d,"");
}
};
var _48e=function _48e(_48f,_490){
var _491,node=document.getElementById(_48f);
if(node){
if(_490=="url(#sketchedHover)"){
_491=node.ownerDocument.createElement("v:fill");
_491.setAttribute("src",rabbit.common.baseUrl+"result/icons/sketchedFilledButton.png");
_491.setAttribute("type","tile");
_491.setAttribute("origin","0.1,0.1");
_491.setAttribute("size","175pt,75pt");
_491.setAttribute("on","true");
node.getElementsByTagName("fill")[0].parentNode.replaceChild(_491,node.getElementsByTagName("fill")[0]);
}else{
_491=node.ownerDocument.createElement("v:fill");
_491.setAttribute("color",_490);
_491.setAttribute("on"," true");
node.getElementsByTagName("fill")[0].parentNode.replaceChild(_491,node.getElementsByTagName("fill")[0]);
}
}
...
return {init:function init(){
_48a.registerOnEvent(rabbit.events.svgFocus,this.onSvgFocus,this);
_48a.registerOnEvent(rabbit.events.svgBlur,this.onSvgBlur,this);
_48a.registerOnEvent(rabbit.events.propertyChange,this.onPropertyChanged,this);
},setFill:function setFill(id,_492){
if(rabbit.facade.vml){
_48e(id,_492);
}else{
_48b(id,_492);
}
},onSvgFocus:function onSvgFocus(_493){
var _494;
if(_493 instanceof Array){
for(var key in _493){
_494=document.getElementById(_493[key]);
if(_494!=null){
_494.setAttribute("class","svg_selected_element");
}
}
}else{
_494=document.getElementById(_493);
if(_494!=null){
_494.setAttribute("class","svg_selected_element");
}
}
},onSvgBlur:function onSvgBlur(_495){
var _496;
if(_495 instanceof Array){
for(var key in _495){
_496=document.getElementById(_495[key]);
if(_496!=null){
_496.setAttribute("class","svg_unselected_element");
}
}
}else{
_496=document.getElementById(_495);
if(_496!=null){
_496.setAttribute("class","svg_unselected_element");
}
}
},onPropertyChanged:function onPropertyChanged(_497,_498){
var _499=document.getElementById(_498);
if(_499==null){
return true;
}
console.debug("Property changed on "+_497);
if(event.srcElement[event.propertyName]==false){
_499.style.setAttribute("display","none");
}else{
_499.style.removeAttribute("display");
}
return true;
}};
}();
...
var _49a=rabbit.facade;
var _49b=function _49b(_49c,_49d){
var node=document.getElementById(_49c);
if(node){
node.style.setProperty("fill",_49d,"");
}
};
var _49e=function _49e(_49f,_4a0){
var _4a1,node=document.getElementById(_49f);
if(node){
if(_4a0=="url(#sketchedHover)"){
_4a1=node.ownerDocument.createElement("v:fill");
_4a1.setAttribute("src",rabbit.common.baseUrl+"result/icons/sketchedFilledButton.png");
_4a1.setAttribute("type","tile");
_4a1.setAttribute("origin","0.1,0.1");
_4a1.setAttribute("size","175pt,75pt");
_4a1.setAttribute("on","true");
node.getElementsByTagName("fill")[0].parentNode.replaceChild(_4a1,node.getElementsByTagName("fill")[0]);
}else{
_4a1=node.ownerDocument.createElement("v:fill");
_4a1.setAttribute("color",_4a0);
_4a1.setAttribute("on"," true");
node.getElementsByTagName("fill")[0].parentNode.replaceChild(_4a1,node.getElementsByTagName("fill")[0]);
}
}
...
return {init:function init(){
_49a.registerOnEvent(rabbit.events.tabButtonMouseOver,this.handleMouseOver,this);
_49a.registerOnEvent(rabbit.events.tabButtonMouseOut,this.handleMouseOut,this);
_49a.registerOnEvent(rabbit.events.pageLoaded,this.changeTab,this);
_49a.registerOnEvent(rabbit.events.pageReady,this.changeTab,this);
this.oldPageId=null;
},changeTab:function(page,_4a2){
var _4a3="";
if(page){
_4a3=page.data.id;
}
if(this.oldPageId===null){
_4a3=_49a.getCurrentPageId();
}
var _4a4=selectorUtil.getElementsByName("target"+this.oldPageId);
for(var i=0;i<_4a4.length;i++){
rabbit.util.removeClass(_4a4[i],"selected");
}
var _4a4=selectorUtil.getElementsByName("target"+_4a3);
for(var i=0;i<_4a4.length;i++){
rabbit.util.addClass(_4a4[i],"selected");
}
this.oldPageId=_49a.getCurrentPageId();
...
if(rabbit.vml){
_49e(id+"_big_path","#EEEEEE");
_49e(id+"_small_path","#EEEEEE");
}else{
_49b(id+"_big_path","#EEEEEE");
_49b(id+"_small_path","#EEEEEE");
}
}
}
catch(e){
...
if(rabbit.vml){
_49e(id+"_big_path","white");
_49e(id+"_small_path","white");
}else{
_49b(id+"_big_path","white");
_49b(id+"_small_path","white");
}
}
}
catch(e){
...
var _4a5=0;
var _4a6=".togglesection-header";
var _4a7=".togglesection-content";
var _4a8="content";
var _4a9="#borderDiv";
var _4aa="open";
var _4ab=rabbit.facade;
var _4ac=function(_4ad,_4ae){
$("#"+_4ad+_4a8).find(".iframe").css("width",_4ae+"px");
};
return {togglers:{},init:function init(){
rabbit.facade.registerOnEvent(rabbit.events.pageLoaded,this.pageLoaded,this);
rabbit.facade.registerOnEvent(rabbit.events.toggleToggleSection,this.toggle,this);
},setupToggler:function(id,_4af,_4b0){
this.togglers[id]={id:id,page:_4af};
$("#"+id).find(_4a6).click(function(){
rabbit.facade.markHighlightTouchesAsSuccessful();
rabbit.facade.raiseEvent(rabbit.events.toggleToggleSection,id);
});
$(_4a9).append($("#"+id).find(_4a7));
},pageLoaded:function(_4b1){
for(var _4b2 in this.togglers){
$("#"+this.togglers[_4b2].id+_4a8).hide();
}
},toggle:function(_4b3){
var _4b4=$("#"+_4b3+">div").data("iframe-url");
var page=rabbit.data.pageStore.objects[_4b4];
$("#"+_4b3+_4a8).slideToggle(_4a5,function(){
$("#"+_4b3).toggleClass(_4aa);
});
}};
}();
...
var _4b5=rabbit.facade;
return {init:function init(){
_4b5.registerOnEvent(rabbit.events.iphoneSwitchClicked,this.onClick,this);
},onClick:function onClick(id){
rabbit.facade.markHighlightTouchesAsSuccessful();
var _4b6=$("#"+id+" .stencil-wrapper > div");
var _4b7=rabbit.events.switchOffSwitch;
_4b6.toggleClass("switch-selected");
if(_4b6.hasClass("switch-selected")){
_4b7=rabbit.events.switchOnSwitch;
}
_4b5.raiseEvent(_4b7,id);
}};
}();
...
var _4b8="rating_white.png";
var _4b9="rating_black.png";
var _4ba=rabbit.facade;
var _4bb=new Array();
var _4bc=function(id){
if(_4bb[id]){
return parseInt(_4bb[id]);
}
return 0;
};
var _4bd=function(id,_4be){
_4bb[id]=_4be;
};
var _4bf=function(id,_4c0){
var i=1;
_4c0=parseInt(_4c0);
while(true){
var _4c1=document.getElementById(id+"-"+i);
if(_4c1==null){
break;
}
var _4c2=_4c1.getAttribute("src");
_4c2=_4c2.substring(0,_4c2.lastIndexOf("/")+1);
if(i>=_4c0+1){
_4c2+=_4b8;
}else{
_4c2+=_4b9;
}
_4c1.setAttribute("src",_4c2);
i++;
}
};
return {init:function init(){
_4ba.registerOnEvent(rabbit.events.ratingResultChangedEvent,this.onClick,this);
_4ba.registerOnEvent(rabbit.events.ratingMouseOut,this.onMouseOut,this);
_4ba.registerOnEvent(rabbit.events.ratingMouseOver,this.onMouseOver,this);
},onLoad:function onLoad(id,_4c3){
_4bd(id,_4c3);
},onClick:function onClick(id,_4c4){
rabbit.facade.markHighlightTouchesAsSuccessful();
_4bd(id,_4c4);
_4bf(id,_4c4);
},onMouseOut:function onMouseOut(id){
_4bf(id,_4bc(id));
},onMouseOver:function onMouseOver(id,_4c5){
_4bf(id,parseInt(_4c5));
},checkMouseOutDiv:function(id,_4c6){
if(_4c6.relatedTarget){
return _4c6.relatedTarget.id.indexOf(id)==-1;
}else{
return _4c6.toElement.id.indexOf(id)==-1;
}
}};
}();
...
},setupTree:function setupMenu(id,_4c8){
try{
_4c8=_4c8.replace(/&quot;/g,"\"");
_4c8=JSON.parse(_4c8);
this._trees[id]=_4c8;
}
catch(e){
console.error(e);
}
},clickCallback:function(_4c9,sth){
var _4ca=document.getElementById(_4c9+"-buttonvline");
var _4cb="open";
if(_4ca){
if(_4ca.style.display=="none"){
_4cb="closed";
}
if(_4cb=="closed"){
_4ca.style.display="";
}else{
_4ca.style.display="none";
}
var elem=document.getElementById(_4c9+"-treeviewnodeid");
...
this.update(_4c9,_4cb);
}
}
},scrollCallback:function(id,_4cc,_4cd){
var _4ce=document.getElementById(id);
_4ce.scrollTop=_4cc;
_4ce.scrollLeft=_4cd;
},update:function(_4cf,_4d0){
this.setStatus(_4cf,_4d0);
this.recalculateLineLengths(_4cf);
},setStatus:function(_4d1,_4d2){
var tree=this.getTree(_4d1);
if(tree){
this.setStatusOnSubtree(this.getTreeName(_4d1),tree,_4d1,_4d2);
}
},setStatusOnSubtree:function(_4d3,tree,_4d4,_4d5){
if(tree){
for(var i=0;i<tree.length;i++){
var node=tree[i];
var _4d6=_4d3+"-"+i;
if(_4d6==_4d4){
node.treeItemType=(_4d5=="closed"?"-":"+");
return true;
}
if(node.subtree){
if(this.setStatusOnSubtree(_4d6,node.subtree,_4d4,_4d5)){
return true;
}
}
}
}
},recalculateLineLengths:function(_4d7){
var tree=this.getTree(_4d7);
if(tree){
var _4d8=this.getTreeName(_4d7);
var _4d9=document.getElementById(_4d8+"-openingvline");
this.traverseTree(_4d8,_4d9,tree,null);
}
},traverseTree:function(_4da,node,_4db,_4dc){
var _4dd=false;
if(_4dc===null){
_4dc={0:0,1:0};
_4dd=true;
...
this.traverseTree(_4da+"-"+i,_4e1,_4e2,_4dc);
_4df=_4de+1;
_4de=_4de+_4dc[0];
_4e0=_4e0+_4dc[1];
}
...
_4e3=document.getElementById(_4da+"-openingvline");
}
if(_4e3){
var _4e4=_4e3.parentNode;
_4e4.style.height=""+(_4c7*_4de)+"px";
var _4e5=(_4df-_4e0)*_4c7;
_4e3.style.top=""+_4e5+"px";
}else{
}
if(_4dd||"+"==node.treeItemType){
_4dc[0]=rows+_4de;
}else{
_4dc[0]=rows;
}
_4dc[1]=rows+_4e0;
},getTree:function(_4e6){
if(_4e6){
var _4e7=this.getTreeName(_4e6);
if(this._trees[_4e7]){
return this._trees[_4e7];
}else{
return null;
}
}
},getTreeName:function(_4e8){
return _4e8.substring(0,_4e8.indexOf("-"));
}};
}();
...
rabbit.common.i18n={translation:{},init:function(_4e9){
this.lang=_4e9.lang;
...
var _4ec=rabbit.common.i18n.translation[lang][_4eb];
if(_4ec!==undefined){
return _4ec;
}
return key;
},tReverse:function(_4ed){
for(var lang in rabbit.common.i18n.translation){
for(var _4ee in rabbit.common.i18n.translation[lang]){
var _4ef=rabbit.common.i18n.translation[lang][_4ee];
if(_4ef==_4ed){
return _4ee;
}
}
...
return null;
},tr:function(key,_4f0){
var _4f1=this.t(key);
for(var k in _4f0){
_4f1=_4f1.replace(k,_4f0[k]);
}
return _4f1;
},translation:{}};
...
},registerUserPref:function(key,_4fc){
this.userDefaults[key]=_4fc;
},setUserPref:function(key,_4fd){
if(rabbit.parameters.userPrefs[key]!=_4fd){
rabbit.parameters.userPrefs[key]=_4fd;
if(!this.doNotUseLocalStorage){
localStorage.setItem(key,JSON.stringify(_4fd));
}
if(!rabbit.parameters.isAnonymous){
...
var _4fe=rabbit.parameters.userPrefs[key];
if(!this.doNotUseLocalStorage&&(_4fe===undefined||_4fe===null)){
_4fe=JSON.parse(localStorage.getItem(key));
if(_4fe!==undefined||_4fe!==null){
this.setUserPref(key,_4fe);
}
}
if(_4fe===undefined||_4fe===null){
...
},registerPrototypePref:function(key,_4ff){
this.prototypeDefaults[key]=_4ff;
},setPrototypePref:function(key,_500){
if(rabbit.parameters.prototypePrefs[key]!=_500){
rabbit.parameters.prototypePrefs[key]=_500;
...
var _501=rabbit.parameters.prototypePrefs[key];
if((_501===undefined)||(_501===null)){
